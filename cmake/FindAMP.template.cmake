...
# Set MPI variables (eventually needs to be moved to the TPL builder)
SET( USE_MPI @USE_MPI@ )
SET( USE_EXT_MPI @USE_EXT_MPI@ )
SET( TEST_MAX_PROCS @TEST_MAX_PROCS@ )
SET( MPI_DIRECTORY @MPI_DIRECTORY@ )
SET( USE_MPI_FOR_SERIAL_TESTS @USE_MPI_FOR_SERIAL_TESTS@ )
SET( MPIEXEC @MPIEXEC@ )
SET( MPIEXEC_NUMPROC_FLAG @MPIEXEC_NUMPROC_FLAG@ )
SET( MPI_INCLUDE @MPI_INCLUDE@ )
SET( MPI_LINK_FLAGS @MPI_LINK_FLAGS@ )
SET( MPI_LIBRARIES @MPI_LIBRARIES@ )
IF ( USE_MPI OR USE_EXT_MPI )
