...
MACRO ( SET_AMP_PACKAGE_FLAGS )
    ...
    ENDIF()
    IF ( ${PROJECT_NAME}_ENABLE_AMP_GRAPHICS )
        SET( USE_AMP_GRAPHICS ON )
        ADD_DEFINITIONS( -D USE_AMP_GRAPHICS )  
        SET( AMP_LIBS graphics ${AMP_LIBS} )
    ENDIF()
    ...
    IF ( USE_EXT_ZLIB )
        ...
        INCLUDE_DIRECTORIES( ${TPL_ZLIB_INCLUDE_DIRS} )
    ENDIF()
