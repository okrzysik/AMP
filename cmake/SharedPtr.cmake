...
FUNCTION( CONFIGURE_SHARED_PTR INSTALL_DIR NAMESPACE )
    ...
    IF ( NOT NAMESPACE )
        SET( NAMESPACE " " )
    ENDIF()
    IF ( MEMORY_SHARED_PTR AND NOT USE_BOOST_SHARED_PTR )
        SET( BOOST_SHARED_PTR 0 )
    ENDIF()
    IF ( DISABLE_BOOST_SHARED_PTR )
        SET( BOOST_SHARED_PTR 0 )
    ENDIF()
    IF ( BOOST_SHARED_PTR )
        ...
        FILE(APPEND "${CMAKE_CURRENT_BINARY_DIR}/tmp/shared_ptr.h" "    using boost::make_shared; \n")
        ...
        FILE(APPEND "${CMAKE_CURRENT_BINARY_DIR}/tmp/shared_ptr.h" "#define USE_BOOST_PTR")
    ELSEIF ( MEMORY_SHARED_PTR )
        ...
        ELSE()
            ...
            FILE(APPEND "${CMAKE_CURRENT_BINARY_DIR}/tmp/shared_ptr.h" "    using std::make_shared; \n")
            #FILE(APPEND "${CMAKE_CURRENT_BINARY_DIR}/tmp/shared_ptr.h" "    using std::enable_shared_from_this; \n")
            FILE(APPEND "${CMAKE_CURRENT_BINARY_DIR}/tmp/shared_ptr.h" "}\n")
            FILE(APPEND "${CMAKE_CURRENT_BINARY_DIR}/tmp/shared_ptr.h" "#define USE_STD_PTR")
        ENDIF()
    ELSEIF ( MEMORY_TR1_SHARED_PTR )
        ...
        FILE(APPEND "${CMAKE_CURRENT_BINARY_DIR}/tmp/shared_ptr.h" "    using std::tr1::make_shared; \n")
        #FILE(APPEND "${CMAKE_CURRENT_BINARY_DIR}/tmp/shared_ptr.h" "    using std::tr1::enable_shared_from_this; \n")
        FILE(APPEND "${CMAKE_CURRENT_BINARY_DIR}/tmp/shared_ptr.h" "}\n")
        FILE(APPEND "${CMAKE_CURRENT_BINARY_DIR}/tmp/shared_ptr.h" "#define USE_TR1_PTR")
