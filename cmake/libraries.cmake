...
MACRO ( CONFIGURE_BOOST )
    ...
    CHECK_ENABLE_FLAG(USES_BOOST 1 )
    IF ( USES_BOOST )
...
MACRO ( CONFIGURE_TRILINOS_LIBRARIES )
    ...
    CHECK_ENABLE_FLAG(USES_TRILINOS 1 )
    IF ( USES_TRILINOS )
...
MACRO ( CONFIGURE_MPI )
    ...
    IF ( USES_MPI )
        ...
        CHECK_ENABLE_FLAG( USES_MPI_FOR_SERIAL_TESTS 0 )
        # Set the definitions
        ADD_DEFINITIONS ( "-D USES_MPI" )  
        MESSAGE ( "Using MPI" )
    ...
    ELSE()
        SET( USES_MPI_FOR_SERIAL_TESTS 0 )
...
MACRO ( CONFIGURE_LIBMESH )
    ...
    CHECK_ENABLE_FLAG(USES_LIBMESH 1 )
    IF ( USES_LIBMESH )
        ...
        IF ( LIBMESH_DIRECTORY )
            ...
            ENDIF ()
            IF ( USES_MPI AND (NOT LIBMESH_PARMETIS_LIB) )
        ...
        ADD_DEFINITIONS ( "-D USES_LIBMESH" )  
...
MACRO ( CONFIGURE_NEK )
    ...
    CHECK_ENABLE_FLAG( USES_NEK "false" )
    IF ( USES_NEK )
...
MACRO ( CONFIGURE_DENDRO )
    ...
    CHECK_ENABLE_FLAG( USES_DENDRO "false" )
    IF ( USES_DENDRO )
        IF ( DENDRO_DIRECTORY )
...
MACRO ( CONFIGURE_SUNDIALS_LIBRARIES )
    ...
    CHECK_ENABLE_FLAG(USES_SUNDIALS 1 )
    IF ( USES_SUNDIALS )
        ...
        IF ( SUNDIALS_DIRECTORY )
            ...
            ENDIF ()
            IF ( USES_MPI AND (NOT SUNDIALS_NVECPARALLEL_LIB) )
        ...
        ENDIF()
        ADD_DEFINITIONS ( "-D USES_SUNDIALS" )  
...
MACRO ( CONFIGURE_PETSC_LIBRARIES )
    ...
    CHECK_ENABLE_FLAG(USES_PETSC 1 )
    IF ( USES_PETSC )
...
MACRO ( CONFIGURE_AMP )
    ...
    IF ( (NOT USE_AMP_MESH) OR (NOT USE_AMP_VECTORS) OR (NOT USE_AMP_MATRICIES) OR (NOT USES_LIBMESH) )
