...
MACRO ( CONFIGURE_OGRE )
    ...
    IF ( USE_EXT_OGRE )
        ...
        IF ( OGRE_DIRECTORY )
            ...
            SET( OGRE_LIBS ${OGRE_LIBRARIES} ${OIS_LIBRARY_DBG} ${OGRE_Overlay_LIBRARIES} )
        ELSE()
...
MACRO ( CONFIGURE_AMP )
    ...
    SET( TPL_LIBS ${OGRE_LIBS} ${NEK_LIBS} ${MOAB_LIBS} ${DENDRO_LIBS} ${NETCDF_LIBS}
        ...
        ${HDF5_LIBS} ${TIMER_LIBS} ${X11_LIBS} ${SUNDIALS_LIBS} ${ZLIB_LIBS} ${BOOST_LIBS} ${Boost_THREAD_LIBRARY_DEBUG} )
