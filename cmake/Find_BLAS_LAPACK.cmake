INCLUDE( ${AMP_SOURCE_DIR}/cmake/BlasLapack/FindBLAS.cmake )
INCLUDE( ${AMP_SOURCE_DIR}/cmake/BlasLapack/FindLAPACK.cmake )
...
FUNCTION( CONFIGURE_BLAS_AND_LAPACK )
    ...
    CHECK_ENABLE_FLAG( USE_MATLAB_LAPACK 1 )
    ...
    IF( USE_MATLAB AND USE_MATLAB_LAPACK ) 
        ...
        FILE(APPEND ${BLAS_LAPACK_HEADER} "#define USE_MATLAB\n" )
...
MACRO( CONFIGURE_MKL )
    ...
    FIND_LIBRARY( MKL_GF      NAMES mkl_rt                  PATHS ${MKL_LIB_PATH}  NO_DEFAULT_PATH )
