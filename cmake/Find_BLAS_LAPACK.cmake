...
FUNCTION( CONFIGURE_BLAS_AND_LAPACK )
    ...
    ELSEIF( USE_VECLIB ) 
        ...
        FILE(APPEND "${BLAS_LAPACK_HEADER}" "#define __ACCELERATE__\n" )
        SET( BLAS_LAPACK_LIBS "-framework Accelerate" PARENT_SCOPE)
        IF ( USING_GCC )
            SET( CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -flax-vector-conversions" PARENT_SCOPE)
            SET( CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -flax-vector-conversions" PARENT_SCOPE)
        ENDIF()
