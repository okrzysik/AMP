...
MACRO ( ADD_USER_FLAGS )
    SET(CMAKE_C_FLAGS   " ${CMAKE_C_FLAGS} ${CFLAGS} ${LDFLAGS} ${LDLIBS}" )
    SET(CMAKE_CXX_FLAGS " ${CMAKE_CXX_FLAGS} ${CXXFLAGS} ${LDFLAGS} ${LDLIBS}" )
...
MACRO ( ADD_AMP_EXE_DEP EXEFILE )
    ...
    TARGET_LINK_LIBRARIES ( ${EXEFILE} ${COVERAGE_LIBS} )
...
MACRO ( SAVE_CMAKE_FLAGS )
    ...
    IF ( USE_AMP_DESCRITIZATION )
        file(APPEND ${AMP_INSTALL_DIR}/amp.cmake "ADD_DEFINITIONS ( -D USE_AMP_DESCRITIZATION ) \n" )
    ENDIF()
    IF ( USE_AMP_VECTORS )
