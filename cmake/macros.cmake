    ...
    IF ( NOT ONLY_BUILD_DOCS AND ( SOURCES OR CUDASOURCES ) )
        ...
        ELSE()
            ...
            FOREACH ( tmp ${TPL_LIBS} )
                TARGET_LINK_LIBRARIES(${PACKAGE} LINK_PUBLIC ${tmp})
            ENDFOREACH()
            FOREACH ( tmp ${EXTERNAL_LIBS} )
                TARGET_LINK_LIBRARIES(${PACKAGE} LINK_PUBLIC ${tmp})
            ENDFOREACH()
            FOREACH ( tmp ${SYSTEM_LDFLAGS} )
                TARGET_LINK_LIBRARIES( ${PACKAGE} LINK_PUBLIC ${tmp} )
            ENDFOREACH()
...
MACRO( INSTALL_PROJ_LIB )
    ...
    FOREACH ( tmp ${TPL_LIBS} )
        TARGET_LINK_LIBRARIES( ${${PROJ}_LIB} LINK_PUBLIC ${tmp} )
    ENDFOREACH()
    FOREACH ( tmp ${EXTERNAL_LIBS} )
        TARGET_LINK_LIBRARIES( ${${PROJ}_LIB} LINK_PUBLIC ${tmp} )
    ENDFOREACH()
...
MACRO( ADD_PROJ_EXE_DEP EXE )
    ...
    TARGET_LINK_LIBRARIES( ${EXE} ${TPL_LIBS} )
