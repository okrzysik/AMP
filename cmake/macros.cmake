...
MACRO ( SAVE_CMAKE_FLAGS )
    ...
    IF ( USES_LIBMESH )
        ...
        file(APPEND ${AMP_INSTALL_DIR}/amp.cmake "SET ( USES_LIBMESH 1 ) \n" )
        file(APPEND ${AMP_INSTALL_DIR}/amp.cmake "ADD_DEFINITIONS ( -D USES_LIBMESH ) \n" )
    ENDIF()
    # Add NEK
    IF ( USES_NEK )
        ...
        file(APPEND ${AMP_INSTALL_DIR}/amp.cmake "SET ( USES_NEK 1 ) \n" )
        file(APPEND ${AMP_INSTALL_DIR}/amp.cmake "ADD_DEFINITIONS ( -D USES_NEK ) \n" )
    ENDIF()
    # Add MOAB
    IF ( USES_MOAB )
        ...
        file(APPEND ${AMP_INSTALL_DIR}/amp.cmake "SET ( USES_MOAB 1 ) \n" )
        file(APPEND ${AMP_INSTALL_DIR}/amp.cmake "ADD_DEFINITIONS ( -D USES_MOAB ) \n" )
    ENDIF()
    # Add DENDRO
    IF ( USES_DENDRO )
        ...
        file(APPEND ${AMP_INSTALL_DIR}/amp.cmake "SET ( USES_DENDRO 1 ) \n" )
        file(APPEND ${AMP_INSTALL_DIR}/amp.cmake "ADD_DEFINITIONS ( -D USES_DENDRO ) \n" )
    ENDIF()
    # Add Trilinos
    IF ( USES_TRILINOS )
        ...
        file(APPEND ${AMP_INSTALL_DIR}/amp.cmake "SET ( USES_TRILINOS 1 ) \n" )
        file(APPEND ${AMP_INSTALL_DIR}/amp.cmake "ADD_DEFINITIONS ( -D USES_TRILINOS ) \n" )
    ENDIF()
    # Add PETsc
    IF ( USES_PETSC )
        ...
        file(APPEND ${AMP_INSTALL_DIR}/amp.cmake "SET ( USES_PETSC 1 ) \n" )
        file(APPEND ${AMP_INSTALL_DIR}/amp.cmake "ADD_DEFINITIONS ( -D USES_PETSC ) \n" )
    ENDIF()
    # Add Sundials
    IF ( USES_SUNDIALS )
        ...
        file(APPEND ${AMP_INSTALL_DIR}/amp.cmake "SET ( USES_SUNDIALS 1 ) \n" )
        file(APPEND ${AMP_INSTALL_DIR}/amp.cmake "ADD_DEFINITIONS ( -D USES_SUNDIALS ) \n" )
    ENDIF()
    # Add Silo
    IF ( USES_SILO )
        ...
        file(APPEND ${AMP_INSTALL_DIR}/amp.cmake "SET ( USES_SILO 1 ) \n" )
        file(APPEND ${AMP_INSTALL_DIR}/amp.cmake "ADD_DEFINITIONS ( -D USES_SILO ) \n" )
    ENDIF()
    # Add Hypre
    IF ( USES_HYPRE )
        ...
        file(APPEND ${AMP_INSTALL_DIR}/amp.cmake "SET ( USES_HYPRE 1 ) \n" )
        file(APPEND ${AMP_INSTALL_DIR}/amp.cmake "ADD_DEFINITIONS ( -D USES_HYPRE ) \n" )
    ENDIF()
    # Add X11
    IF ( USES_X11 )
        ...
        file(APPEND ${AMP_INSTALL_DIR}/amp.cmake "SET ( USES_X11 1 ) \n" )
        file(APPEND ${AMP_INSTALL_DIR}/amp.cmake "ADD_DEFINITIONS ( -D USES_X11 ) \n" )
    ENDIF()
    # Add HDF5
    IF ( USES_HDF5 )
        ...
        file(APPEND ${AMP_INSTALL_DIR}/amp.cmake "SET ( USES_HDF5 1 ) \n" )
        file(APPEND ${AMP_INSTALL_DIR}/amp.cmake "ADD_DEFINITIONS ( -D USES_HDF5 ) \n" )
    ENDIF()
    # Add MPI
    IF ( USES_MPI )
        ...
        file(APPEND ${AMP_INSTALL_DIR}/amp.cmake "SET ( USES_MPI 1 ) \n" )
        file(APPEND ${AMP_INSTALL_DIR}/amp.cmake "ADD_DEFINITIONS ( -D USES_MPI ) \n" )
        ...
        file(APPEND ${AMP_INSTALL_DIR}/amp.cmake "SET(USES_MPI_FOR_SERIAL_TESTS ${USES_MPI_FOR_SERIAL_TESTS} )\n" )
    ELSE()
        file(APPEND ${AMP_INSTALL_DIR}/amp.cmake "SET(USES_MPI_FOR_SERIAL_TESTS 0 )\n" )
    ENDIF()
    # Add LAPACK and BLAS
