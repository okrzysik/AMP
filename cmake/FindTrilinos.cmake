...
FUNCTION ( TRILINOS_SET_LIBRARIES )
    ...
    IF ( (NOT TRILINOS_EPETRA_LIB) OR (NOT TRILINOS_EPETRAEXT_LIB) OR (NOT TRILINOS_KOKKOS_LIB) OR (NOT TRILINOS_RTOP_LIB) )
    ...
    ENDIF()
    # Get the TEUCHOS libraries
    IF ( ${TRILINOS_VERSION} LESS 110100 )
        FIND_LIBRARY ( TRILINOS_TEUCHOS_LIBS     NAMES teuchos     PATHS ${TRILINOS_DIRECTORY}/lib   NO_DEFAULT_PATH )
        IF ( NOT TRILINOS_TEUCHOS_LIBS )
            MESSAGE ( ${TRILINOS_TEUCHOS_LIBS} )
            MESSAGE ( FATAL_ERROR "Trilinos libraries not found in ${TRILINOS_DIRECTORY}/lib" )
        ENDIF()
    ELSEIF( ${TRILINOS_VERSION} LESS 120000 )
        FIND_LIBRARY ( TRILINOS_TEUCHOSREMAINER_LIBS   NAMES teuchosremainder      PATHS ${TRILINOS_DIRECTORY}/lib   NO_DEFAULT_PATH )
        ...
        IF ( (NOT TRILINOS_TEUCHOS_LIBS) OR (NOT TRILINOS_TEUCHOSREMAINER_LIBS) OR (NOT TRILINOS_TEUCHOSCOMM_LIBS) OR 
             (NOT TRILINOS_TEUCHOSPARAMETER_LIBS) OR (NOT TRILINOS_TEUCHOSSCORE_LIBS) OR  )
            MESSAGE ( ${TRILINOS_TEUCHOSREMAINER_LIBS} )
    ...
    SET ( TRILINOS_LIBS
        ...
        ${TRILINOS_NOX_LIBS}
        ${TRILINOS_VEC_LIBS}
        ${TRILINOS_TRILINOS_TEUCHOS_LIBS}
        ${TRILINOS_UTILS_LIBS}
        PARENT_SCOPE
    )
ENDFUNCTION ()
