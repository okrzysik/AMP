...
namespace AMP {
  namespace Operator {
    ...
    */
    ...
    void PressureBoundaryVectorCorrection :: apply(AMP::LinearAlgebra::Vector::const_shared_ptr f, AMP::LinearAlgebra::Vector::const_shared_ptr u, AMP::LinearAlgebra::Vector::shared_ptr r, const double a , const double b )
    {
