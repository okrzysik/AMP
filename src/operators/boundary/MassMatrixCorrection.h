...
namespace Operator {
  ...
  /**
    A class used to impose HOMOGENEOUS Dirichlet boundary conditions for a mass operator. This is a minor modification of the class
    DirichletMatrixCorrection. A feature to handle nonhomogeneous boundary condition needs to be implemented soon. 
   */
