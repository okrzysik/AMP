...
/*          // Strain Displacement Relation For Columns (Voigt Notation)
          ...
          for(int c = 0; c < 3; c++) {
            uStrain[c] = uStrain[c] + ((avgTraceTerm[(3*j) + d1] - dphi[j][qp](d1))/3.0);
          }//end for c
...
/*              // Strain Displacement Relation For Rows (Voigt Notation) 
              ...
              for(int c = 0; c < 3; c++) {
                wStrain[c] = wStrain[c] + ((avgTraceTerm[(3*k) + d2] - dphi[k][qp](d2))/3.0);
              }//end for c
...
*/
              ...
              elementStiffnessMatrix[(3*k) + d2][(3*j) + d1] += (JxW[qp] * materialStiffness[(3 * k) + d2][(3 * j) + d1]);
