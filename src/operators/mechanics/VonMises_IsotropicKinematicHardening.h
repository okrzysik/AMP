...
namespace Operator {
  ...
  class VonMises_IsotropicKinematicHardening : public MechanicsMaterialModel 
  {
    public :
      ...
      explicit VonMises_IsotropicKinematicHardening(const AMP::shared_ptr<MechanicsMaterialModelParameters>& );
    ...
    protected :
      ...
      void radialReturn(const double* stra_np1, double* stre_np1, double* back_stress_np1,
