...
public :
    ...
    //! Constructor.
    MechanicsNonlinearElement(const boost::shared_ptr<ElementOperationParameters>& params) :
...
template <>
inline void MechanicsNonlinearElement :: materialModelPreNonlinearElementOperation< MechanicsNonlinearElement::RESET>()
{
...
void MechanicsNonlinearElement :: updateMaterialModel( const std::vector<std::vector<double> > & elementInputVectors )
{
