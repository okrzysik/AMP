#ifndef included_AMP_ThermalMap
#define included_AMP_ThermalMap
...
namespace Operator {
  ...
  class ThermalMap : public AsyncMapOperator 
  {
    public:
      typedef  boost::shared_ptr<ThermalMapParameters>   params_shared_ptr;
    ...
    public:
      ...
      /** \brief  Typedef to identify the parameters class of this operator
        */
      typedef ThermalMapParameters   Parameters;
      ...
      /** Constructor
        */
      ThermalMap ( const boost::shared_ptr<AMP::Operator::OperatorParameters> & params );
      /** Destructor
        */
      virtual ~ThermalMap ();
