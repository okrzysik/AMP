...
protected :
    ...
    boost::shared_ptr<AMP::Discretization::NodalVariable> d_inpVariable; /**< Nodal Scalar Variable */

    boost::shared_ptr<AMP::LinearAlgebra::Variable> d_outVariable; /**< Simple Input Variable */
