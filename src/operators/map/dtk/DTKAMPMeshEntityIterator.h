...
public:
    ...
    explicit AMPMeshEntityIterator(
        ...
        const std::shared_ptr<std::map<AMP::Mesh::MeshElementID, DataTransferKit::EntityId>>
            &id_map,
...
private:
    ...
    // Mesh id map.
    std::shared_ptr<std::map<AMP::Mesh::MeshElementID, DataTransferKit::EntityId>> d_id_map;
};
