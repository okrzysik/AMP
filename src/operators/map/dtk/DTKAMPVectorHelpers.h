...
public:
     ...
     */
    static Teuchos::RCP<Tpetra::Vector<double, int, std::size_t>> pullTpetraVectorFromAMPVector(
     ...
     */
    static Teuchos::RCP<const Tpetra::Map<int, std::size_t>> createTpetraMapFromAMPDOFManager(
