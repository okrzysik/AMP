...
MultiDofDTKMapOperator::MultiDofDTKMapOperator( const AMP::shared_ptr<OperatorParameters> &params )
{
    ...
    // Build map 1 -> 2
    d_SourceVectorMap12 =
        sourceVector->constSelect( AMP::LinearAlgebra::VS_Mesh( boundaryMesh1 ), "var" )
    ...
    d_TargetVectorMap12 =
        targetVector->select( AMP::LinearAlgebra::VS_Mesh( boundaryMesh2 ), "var" )
    ...
    // Build map 2 -> 1
    d_SourceVectorMap21 =
        sourceVector->constSelect( AMP::LinearAlgebra::VS_Mesh( boundaryMesh2 ), "var" )
    ...
    d_TargetVectorMap21 =
        targetVector->select( AMP::LinearAlgebra::VS_Mesh( boundaryMesh1 ), "var" )
                                    ...
                                    AMP::LinearAlgebra::Vector::shared_ptr r)
{
    ...
    // Build map 1 -> 2
    d_SourceVectorMap12 =
        u->constSelect( AMP::LinearAlgebra::VS_Mesh( boundaryMesh1 ), "var" )
            ->constSelect( AMP::LinearAlgebra::VS_ByVariableName( variable1 ), "var" )
            ->constSelect( AMP::LinearAlgebra::VS_Stride( strideOffset1, strideLength1 ), "var" );

    // Build map 2 -> 1
    d_SourceVectorMap21 =
        u->constSelect( AMP::LinearAlgebra::VS_Mesh( boundaryMesh2 ), "var" )
            ->constSelect( AMP::LinearAlgebra::VS_ByVariableName( variable2 ), "var" )
            ->constSelect( AMP::LinearAlgebra::VS_Stride( strideOffset2, strideLength2 ), "var" );
