...
namespace Operator {
  ...
  void NavierStokesLSWFElement :: initTransportModel() 
  {
    d_fe->reinit(d_elem);
  }
...
/*
        ...
        dtxxdx += (elementInputVectors[NavierStokes::PRINCIPALSTRESS][(3*k) + 0]*dphi[k][qp](0));
        dtyydy += (elementInputVectors[NavierStokes::PRINCIPALSTRESS][(3*k) + 1]*dphi[k][qp](1));
        dtzzdz += (elementInputVectors[NavierStokes::PRINCIPALSTRESS][(3*k) + 2]*dphi[k][qp](2));
        ...
        dtxydx += (elementInputVectors[NavierStokes::SHEARSTRESS][(3*k) + 0]*dphi[k][qp](0));
        dtyzdy += (elementInputVectors[NavierStokes::SHEARSTRESS][(3*k) + 1]*dphi[k][qp](1));
        dtxzdz += (elementInputVectors[NavierStokes::SHEARSTRESS][(3*k) + 2]*dphi[k][qp](2));

        dtxydy += (elementInputVectors[NavierStokes::SHEARSTRESS][(3*k) + 0]*dphi[k][qp](1));
        dtyzdz += (elementInputVectors[NavierStokes::SHEARSTRESS][(3*k) + 1]*dphi[k][qp](2));
        dtxzdx += (elementInputVectors[NavierStokes::SHEARSTRESS][(3*k) + 2]*dphi[k][qp](0));
*/        
      } //end for k
      ...
      for(unsigned int k = 0; k < num_nodes; k++) {
        ...
        derror[1][1] = (phi[k][qp]*dudx + u *dphi[k][qp](0) + v *dphi[k][qp](1) + w *dphi[k][qp](2));
        ...
        derror[2][2] = (phi[k][qp]*dvdy + v *dphi[k][qp](1) + u *dphi[k][qp](0) + w *dphi[k][qp](2));
        ...
        derror[3][3] = (phi[k][qp]*dwdz + w *dphi[k][qp](2) + u *dphi[k][qp](0) + v *dphi[k][qp](1)); 
