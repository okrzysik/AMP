...
#ifndef included_AMP_ConsMassGalWFLinearElement
#define included_AMP_ConsMassGalWFLinearElement
...
namespace Operator {
  ...
  class ConsMassGalWFLinearElement : public FlowElement 
  {
    public :

      ConsMassGalWFLinearElement(const boost::shared_ptr<ElementOperationParameters>& params)
        : FlowElement(params) {
