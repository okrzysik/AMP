...
//--------------------------------------------------
  ...
  {
    // construct it.
    AMP::shared_ptr<AMP::Operator::NeutronicsRhsParameters> ntxPrm( new AMP::Operator::NeutronicsRhsParameters(ntx_db) );
    AMP::shared_ptr<AMP::Operator::NeutronicsRhs>           ntxRhs( new AMP::Operator::NeutronicsRhs(ntxPrm) );
  ...
  {
    AMP::shared_ptr<AMP::Operator::NeutronicsRhs> ntxBld = AMP::dynamic_pointer_cast<AMP::Operator::NeutronicsRhs>(AMP::Operator::OperatorBuilder::createOperator(meshAdapter,
																				      "NeutronicsRhs",
																				      input_db,
																				      unusedModel));
