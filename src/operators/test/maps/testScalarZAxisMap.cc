...
static void runTest( const std::string &fname, AMP::UnitTest *ut )
{
    ...
    auto mesh1    = map_db->getStringArray( "Mesh1" );
    auto mesh2    = map_db->getStringArray( "Mesh2" );
    auto surface1 = map_db->getIntegerArray( "Surface1" );
    auto surface2 = map_db->getIntegerArray( "Surface2" );
