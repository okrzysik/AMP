...
void myTest(AMP::UnitTest *ut)
{
	...
	vector = AMP::LinearAlgebra::createVector(dofManager, variable, split);
	...
	dtk_shape_function->evaluateGradient( 
	    *dtk_elem_iterator, ref_center(), gradients );
    ...
    for ( dtk_node_iterator = dtk_node_iterator.begin(),
	      node_iterator = node_iterator.begin();
