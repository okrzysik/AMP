...
void dtkConsruction(AMP::UnitTest *ut, std::string input_file)
{
  ...
  AMP::Discretization::DOFManager::shared_ptr nodalDofMap      = AMP::Discretization::simpleDOFManager::create(manager, AMP::Mesh::Vertex, 1,      1,    true);
  AMP::LinearAlgebra::Variable::shared_ptr variable(new AMP::LinearAlgebra::Variable("Field"));
  AMP::LinearAlgebra::Vector::shared_ptr  fieldVec = AMP::LinearAlgebra::createVector( nodalDofMap, variable );
  AMP::LinearAlgebra::Vector::shared_ptr  resVec   = AMP::LinearAlgebra::createVector( nodalDofMap, variable );
  AMP::LinearAlgebra::Vector::shared_ptr  dummyVec = AMP::LinearAlgebra::createVector( nodalDofMap, variable );
  AMP::LinearAlgebra::Vector::shared_ptr  mapVec   = AMP::LinearAlgebra::createVector( nodalDofMap, variable , true);
