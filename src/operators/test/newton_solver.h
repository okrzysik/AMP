...
struct solve_status_t {
 solve_status_t(status_t s, size_t i, double r) : status(s), n_iterations(i), final_residual_norm(r) { }
 status_t status;
 size_t n_iterations;
...
private:
 ...
 void (*compute_action_inverse_jacobian_on_minus_residual)(vector_t const & solution, vector_t const & residual, vector_t & update, void * parameters);

};

template<typename vector_t>
void newton_solver_t<vector_t>::set(void (*my_compute_residual)(vector_t const &, vector_t &, void *),
                                   void (*my_compute_action_inverse_jacobian_on_minus_residual)(vector_t const &, vector_t const &, vector_t &, void *)) {
   compute_residual = my_compute_residual;
   compute_action_inverse_jacobian_on_minus_residual = my_compute_action_inverse_jacobian_on_minus_residual;
 }
