...
inline double r_squared(const double x, const double y, const double z){return x*x+y*y+z*z;}
inline double radius(const double x, const double y, const double z){return sqrt( r_squared(x,y,z) );}
