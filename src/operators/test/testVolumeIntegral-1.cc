...
//--------------------------------------------------
  ...
  // test reset
  try {
      boost::shared_ptr<AMP::Operator::VolumeIntegralOperatorParameters> volumeIntegralParameters (new AMP::Operator::VolumeIntegralOperatorParameters( sourceDatabase ) );
