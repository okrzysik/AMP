...
#define __SOL_FN__(f, x, y, z) ( (__SQUARE__(sin(static_cast<double>(f)*__PI__*(x)))) +\
    (__SQUARE__(sin(static_cast<double>(f)*__PI__*(y)))) +\
    (__SQUARE__(sin(static_cast<double>(f)*__PI__*(z)))) )


AMP::LinearAlgebra::Vector::shared_ptr  getInitialGuess ( AMP::LinearAlgebra::Vector::shared_ptr solution , AMP::MeshManager::Adapter::shared_ptr meshAdapter  ,
...
AMP::LinearAlgebra::Vector::shared_ptr  getInitialGuess ( AMP::MeshManager::Adapter::shared_ptr meshAdapter  ,
                                      AMP::Database::shared_ptr input_db )
{
