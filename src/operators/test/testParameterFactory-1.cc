...
void ParameterFactoryTest(AMP::UnitTest *ut)
{
    ...
    AMP::shared_ptr<AMP::Operator::OperatorParameters> operatorParameters = AMP::Operator::ParameterFactory::createParameter(elemOp_db, mesh);
    ...
    if(elemOp_db->getString("name")=="DirichletMatrixCorrection") {
        AMP::shared_ptr<AMP::Operator::DirichletMatrixCorrectionParameters> operatorParams =
            AMP::dynamic_pointer_cast<AMP::Operator::DirichletMatrixCorrectionParameters>(operatorParameters);
