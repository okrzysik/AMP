...
void computeFuelTemperature( AMP::Mesh::Mesh::shared_ptr meshAdapter,
...
void computeCladTemperature( AMP::Mesh::Mesh::shared_ptr meshAdapter,
                             AMP::LinearAlgebra::Vector::shared_ptr temperatureField,
...
void applyCustomDirichletCondition(
