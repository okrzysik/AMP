...
void Test(AMP::UnitTest *ut, std::string exeName)
{
  ...
  AMP::shared_ptr<AMP::Database> subchannelOperator_db = input_db->getDatabase("SubchannelFourEqNonlinearOperator");
  ...
  compare_face_value("Axial mass flow rate",0,1,m_res,-0.00111607071154988,passed_known_test);
  compare_face_value("Axial mass flow rate",0,2,m_res,0.00257700800092406,passed_known_test);
  compare_face_value("Axial mass flow rate",0,3,m_res,0.002817654074108,passed_known_test);
  compare_face_value("Axial mass flow rate",0,4,m_res,-0.000865202566793987,passed_known_test);
  compare_face_value("Axial mass flow rate",0,5,m_res,-0.001262287611432,passed_known_test);
  compare_face_value("Axial mass flow rate",0,6,m_res,0.00240370180328643,passed_known_test);
  compare_face_value("Axial mass flow rate",0,7,m_res,0.00295650933981623,passed_known_test);
  compare_face_value("Axial mass flow rate",0,8,m_res,-0.000685998128451605,passed_known_test);
  compare_face_value("Axial mass flow rate",0,9,m_res,-0.00139353069976071,passed_known_test);
  compare_face_value("Axial mass flow rate",1,0,m_res,0.0379690653800828,passed_known_test);
  compare_face_value("Axial mass flow rate",1,1,m_res,0.00189262765551727,passed_known_test);
  compare_face_value("Axial mass flow rate",1,2,m_res,-0.000947622136685143,passed_known_test);
  compare_face_value("Axial mass flow rate",1,3,m_res,-0.00113682128239614,passed_known_test);
  compare_face_value("Axial mass flow rate",1,4,m_res,0.00169539178108148,passed_known_test);
  compare_face_value("Axial mass flow rate",1,5,m_res,0.00200489658671673,passed_known_test);
  compare_face_value("Axial mass flow rate",1,6,m_res,-0.000814169450369545,passed_known_test);
  compare_face_value("Axial mass flow rate",1,7,m_res,-0.00124342146158573,passed_known_test);
  compare_face_value("Axial mass flow rate",1,8,m_res,0.00155741097325171,passed_known_test);
  compare_face_value("Axial mass flow rate",1,9,m_res,0.00210563567008801,passed_known_test);
  compare_face_value("Axial mass flow rate",2,0,m_res,0.0379264080874497,passed_known_test);
  compare_face_value("Axial mass flow rate",2,1,m_res,0.00353542660640621,passed_known_test);
  compare_face_value("Axial mass flow rate",2,2,m_res,-0.00324059158527243,passed_known_test);
  compare_face_value("Axial mass flow rate",2,3,m_res,-0.00367307921250371,passed_known_test);
  compare_face_value("Axial mass flow rate",2,4,m_res,0.00308456793567051,passed_known_test);
  compare_face_value("Axial mass flow rate",2,5,m_res,0.0038041043058722,passed_known_test);
  compare_face_value("Axial mass flow rate",2,6,m_res,-0.00292297865242048,passed_known_test);
  compare_face_value("Axial mass flow rate",2,7,m_res,-0.00392826547166117,passed_known_test);
  compare_face_value("Axial mass flow rate",2,8,m_res,0.00275611529880499,passed_known_test);
  compare_face_value("Axial mass flow rate",2,9,m_res,0.00404533867993266,passed_known_test);
  compare_face_value("Axial mass flow rate",3,0,m_res,0.0379514108598289,passed_known_test);
  compare_face_value("Axial mass flow rate",3,1,m_res,0.00274082883951322,passed_known_test);
  compare_face_value("Axial mass flow rate",3,2,m_res,-0.00172790014067486,passed_known_test);
  compare_face_value("Axial mass flow rate",3,3,m_res,-0.00201816681608982,passed_known_test);
  compare_face_value("Axial mass flow rate",3,4,m_res,0.00243823232762159,passed_known_test);
  compare_face_value("Axial mass flow rate",3,5,m_res,0.00291779621615355,passed_known_test);
  compare_face_value("Axial mass flow rate",3,6,m_res,-0.00151823219668687,passed_known_test);
  compare_face_value("Axial mass flow rate",3,7,m_res,-0.00218622799824502,passed_known_test);
  compare_face_value("Axial mass flow rate",3,8,m_res,0.00222142554521501,passed_known_test);
  compare_face_value("Axial mass flow rate",3,9,m_res,0.00307664796298427,passed_known_test);
  compare_face_value("Axial mass flow rate",4,0,m_res,0.0380210862636011,passed_known_test);
  compare_face_value("Axial mass flow rate",4,1,m_res,-0.00101293482593628,passed_known_test);
  compare_face_value("Axial mass flow rate",4,2,m_res,0.000925248740600401,passed_known_test);
  compare_face_value("Axial mass flow rate",4,3,m_res,0.00105223718696533,passed_known_test);
  compare_face_value("Axial mass flow rate",4,4,m_res,-0.000880552213066112,passed_known_test);
  compare_face_value("Axial mass flow rate",4,5,m_res,-0.00108964094604573,passed_known_test);
  compare_face_value("Axial mass flow rate",4,6,m_res,0.000834266863003721,passed_known_test);
  compare_face_value("Axial mass flow rate",4,7,m_res,0.00112507861378369,passed_known_test);
  compare_face_value("Axial mass flow rate",4,8,m_res,-0.000786476205286927,passed_known_test);
  compare_face_value("Axial mass flow rate",4,9,m_res,-0.00115848624829812,passed_known_test);
  compare_face_value("Axial mass flow rate",5,0,m_res,0.0380713750538627,passed_known_test);
  compare_face_value("Axial mass flow rate",5,1,m_res,-0.00383543782609493,passed_known_test);
  compare_face_value("Axial mass flow rate",5,2,m_res,0.00272899559274731,passed_known_test);
  compare_face_value("Axial mass flow rate",5,3,m_res,0.00315529995121174,passed_known_test);
  compare_face_value("Axial mass flow rate",5,4,m_res,-0.00339102507464462,passed_known_test);
  compare_face_value("Axial mass flow rate",5,5,m_res,-0.00409540171604186,passed_known_test);
  compare_face_value("Axial mass flow rate",5,6,m_res,0.00242100306907703,passed_known_test);
  compare_face_value("Axial mass flow rate",5,7,m_res,0.00340218105290036,passed_known_test);
  compare_face_value("Axial mass flow rate",5,8,m_res,-0.00307254563025331,passed_known_test);
  compare_face_value("Axial mass flow rate",5,9,m_res,-0.00432875457007729,passed_known_test);
  compare_face_value("Axial mass flow rate",6,0,m_res,0.0380560419487658,passed_known_test);
  compare_face_value("Axial mass flow rate",6,1,m_res,-0.00269234154998653,passed_known_test);
  compare_face_value("Axial mass flow rate",6,2,m_res,0.00246929880233966,passed_known_test);
  compare_face_value("Axial mass flow rate",6,3,m_res,0.00279723147715915,passed_known_test);
  compare_face_value("Axial mass flow rate",6,4,m_res,-0.00235047907681835,passed_known_test);
  compare_face_value("Axial mass flow rate",6,5,m_res,-0.00289707422561653,passed_known_test);
  compare_face_value("Axial mass flow rate",6,6,m_res,0.0022274182693329,passed_known_test);
  compare_face_value("Axial mass flow rate",6,7,m_res,0.00299168964430632,passed_known_test);
  compare_face_value("Axial mass flow rate",6,8,m_res,-0.0021003384243919,passed_known_test);
  compare_face_value("Axial mass flow rate",6,9,m_res,-0.00308090701409712,passed_known_test);
  compare_face_value("Axial mass flow rate",7,0,m_res,0.0379891841344244,passed_known_test);
  compare_face_value("Axial mass flow rate",7,1,m_res,0.00011306696483164,passed_known_test);
  compare_face_value("Axial mass flow rate",7,2,m_res,-0.000889007249895837,passed_known_test);
  compare_face_value("Axial mass flow rate",7,3,m_res,-0.000946888976408175,passed_known_test);
  compare_face_value("Axial mass flow rate",7,4,m_res,5.27265605470775e-05,passed_known_test);
  compare_face_value("Axial mass flow rate",7,5,m_res,0.000153069572332974,passed_known_test);
  compare_face_value("Axial mass flow rate",7,6,m_res,-0.000842283632664553,passed_known_test);
  compare_face_value("Axial mass flow rate",7,7,m_res,-0.000984906876022336,passed_known_test);
  compare_face_value("Axial mass flow rate",7,8,m_res,4.38803356166644e-06,passed_known_test);
  compare_face_value("Axial mass flow rate",7,9,m_res,0.000189034166543037,passed_known_test);
  compare_face_value("Axial mass flow rate",8,0,m_res,0.0379322703770131,passed_known_test);
  compare_face_value("Axial mass flow rate",8,1,m_res,0.00244031939765477,passed_known_test);
  compare_face_value("Axial mass flow rate",8,2,m_res,-0.00378901584924407,passed_known_test);
  compare_face_value("Axial mass flow rate",8,3,m_res,-0.00419338596460365,passed_known_test);
  compare_face_value("Axial mass flow rate",8,4,m_res,0.00201877260367274,passed_known_test);
  compare_face_value("Axial mass flow rate",8,5,m_res,0.0026870204073839,passed_known_test);
  compare_face_value("Axial mass flow rate",8,6,m_res,-0.00349675258706133,passed_known_test);
  compare_face_value("Axial mass flow rate",8,7,m_res,-0.00442767232760942,passed_known_test);
  compare_face_value("Axial mass flow rate",8,8,m_res,0.00171655741524677,passed_known_test);
  compare_face_value("Axial mass flow rate",8,9,m_res,0.00290846938956146,passed_known_test);
  ...
  compare_gap_value("Lateral mass flow rate",0,3,w_res,-18449.1651505823,passed_known_test);
  compare_gap_value("Lateral mass flow rate",0,4,w_res,-1962.73735876877,passed_known_test);
  ...
  compare_gap_value("Lateral mass flow rate",0,7,w_res,-18249.2820620335,passed_known_test);
  compare_gap_value("Lateral mass flow rate",0,8,w_res,-3518.05845909234,passed_known_test);
  compare_gap_value("Lateral mass flow rate",1,0,w_res,0.000999911615371665,passed_known_test);
  compare_gap_value("Lateral mass flow rate",1,1,w_res,-10842.9879036625,passed_known_test);
  ...
  compare_gap_value("Lateral mass flow rate",1,5,w_res,-10764.7651134222,passed_known_test);
  compare_gap_value("Lateral mass flow rate",1,6,w_res,-1607.68328043691,passed_known_test);
  ...
  compare_gap_value("Lateral mass flow rate",2,1,w_res,-30216.2315780837,passed_known_test);
  compare_gap_value("Lateral mass flow rate",2,2,w_res,-1925.84978424341,passed_known_test);
  ...
  compare_gap_value("Lateral mass flow rate",2,5,w_res,-29998.2475732798,passed_known_test);
  compare_gap_value("Lateral mass flow rate",2,6,w_res,-4480.14242528513,passed_known_test);
  ...
  compare_gap_value("Lateral mass flow rate",3,2,w_res,-1389.99776310714,passed_known_test);
  ...
  compare_gap_value("Lateral mass flow rate",3,5,w_res,-21651.4795570349,passed_known_test);
  ...
  compare_gap_value("Lateral mass flow rate",4,3,w_res,-6631.52700804774,passed_known_test);
  compare_gap_value("Lateral mass flow rate",4,4,w_res,-705.503249970196,passed_known_test);
  ...
  compare_gap_value("Lateral mass flow rate",4,7,w_res,-6559.67930627218,passed_known_test);
  ...
  compare_gap_value("Lateral mass flow rate",5,3,w_res,-28915.8261650702,passed_known_test);
  compare_gap_value("Lateral mass flow rate",5,4,w_res,-3076.24610926885,passed_known_test);
  ...
  compare_gap_value("Lateral mass flow rate",5,7,w_res,-28602.5445279784,passed_known_test);
  compare_gap_value("Lateral mass flow rate",5,8,w_res,-5513.93877441103,passed_known_test);
  ...
  compare_gap_value("Lateral mass flow rate",6,4,w_res,-1572.31449618199,passed_known_test);
  ...
  compare_gap_value("Lateral mass flow rate",6,7,w_res,-14619.1797907007,passed_known_test);
  compare_gap_value("Lateral mass flow rate",6,8,w_res,-2818.25495136741,passed_known_test);
  compare_gap_value("Lateral mass flow rate",7,0,w_res,0.000999969097526927,passed_known_test);
  compare_gap_value("Lateral mass flow rate",7,1,w_res,-14522.8129655036,passed_known_test);
  ...
  compare_gap_value("Lateral mass flow rate",7,5,w_res,-14418.0434176786,passed_known_test);
  compare_gap_value("Lateral mass flow rate",7,6,w_res,-2153.28871099462,passed_known_test);
  ...
  compare_gap_value("Lateral mass flow rate",8,3,w_res,-13897.7997924659,passed_known_test);
  compare_gap_value("Lateral mass flow rate",8,4,w_res,-1478.53465821826,passed_known_test);
  ...
  compare_gap_value("Lateral mass flow rate",8,7,w_res,-13747.2273920973,passed_known_test);
  compare_gap_value("Lateral mass flow rate",8,8,w_res,-2650.16172605263,passed_known_test);
  ...
  compare_gap_value("Lateral mass flow rate",9,3,w_res,-8867.21344500693,passed_known_test);
  ...
  compare_gap_value("Lateral mass flow rate",9,7,w_res,-8771.14373945173,passed_known_test);
  compare_gap_value("Lateral mass flow rate",9,8,w_res,-1690.88266452952,passed_known_test);
  compare_gap_value("Lateral mass flow rate",10,0,w_res,0.00100000093996551,passed_known_test);
  compare_gap_value("Lateral mass flow rate",10,1,w_res,-10481.958524698,passed_known_test);
  compare_gap_value("Lateral mass flow rate",10,2,w_res,-668.0739063223,passed_known_test);
  compare_gap_value("Lateral mass flow rate",10,3,w_res,10453.5803397917,passed_known_test);
  compare_gap_value("Lateral mass flow rate",10,4,w_res,1112.1170841339,passed_known_test);
  compare_gap_value("Lateral mass flow rate",10,5,w_res,-10406.3402547761,passed_known_test);
  compare_gap_value("Lateral mass flow rate",10,6,w_res,-1554.15361037873,passed_known_test);
  compare_gap_value("Lateral mass flow rate",10,7,w_res,10340.323516158,passed_known_test);
  compare_gap_value("Lateral mass flow rate",10,8,w_res,1993.38590827519,passed_known_test);
  ...
  compare_gap_value("Lateral mass flow rate",11,2,w_res,756.084977656127,passed_known_test);
  compare_gap_value("Lateral mass flow rate",11,3,w_res,-11830.7187478497,passed_known_test);
  compare_gap_value("Lateral mass flow rate",11,4,w_res,-1258.62570699965,passed_known_test);
  compare_gap_value("Lateral mass flow rate",11,5,w_res,11777.2553300435,passed_known_test);
  compare_gap_value("Lateral mass flow rate",11,6,w_res,1758.89544331628,passed_known_test);
  compare_gap_value("Lateral mass flow rate",11,7,w_res,-11702.5416421479,passed_known_test);
  compare_gap_value("Lateral mass flow rate",11,8,w_res,-2255.99151465695,passed_known_test);
