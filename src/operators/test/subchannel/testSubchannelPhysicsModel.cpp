...
static void nonlinearTest( AMP::UnitTest *ut, const std::string &exeName )
{
    ...
    std::map<std::string, std::shared_ptr<std::vector<double>>> liquidEnthalpyArgs;
    liquidEnthalpyArgs.insert( std::make_pair( "pressure", pressureInput ) );
    std::map<std::string, std::shared_ptr<std::vector<double>>> volumeArgs;
    volumeArgs.insert( std::make_pair( "enthalpy", enthalpyInput ) );
    volumeArgs.insert( std::make_pair( "pressure", pressureInput ) );
    std::map<std::string, std::shared_ptr<std::vector<double>>> conductivityArgs;
    ...
    std::map<std::string, std::shared_ptr<std::vector<double>>> viscosityArgs;
    viscosityArgs.insert( std::make_pair( "temperature", temperatureInput ) );
    viscosityArgs.insert( std::make_pair( "density", densityInput ) );
    std::map<std::string, std::shared_ptr<std::vector<double>>> enthalpyArgs;
    ...
    std::map<std::string, std::shared_ptr<std::vector<double>>> temperatureArgs1;
    temperatureArgs1.insert( std::make_pair( "enthalpy", enthalpyInput ) );
    std::map<std::string, std::shared_ptr<std::vector<double>>> temperatureArgs0;
    std::map<std::string, std::shared_ptr<std::vector<double>>> liquidEnthalpyArgs0;
    std::map<std::string, std::shared_ptr<std::vector<double>>> volumeArgs1;
    volumeArgs1.insert( std::make_pair( "enthalpy", enthalpyInput ) );
    std::map<std::string, std::shared_ptr<std::vector<double>>> volumeArgs0;
    std::map<std::string, std::shared_ptr<std::vector<double>>> conductivityArgs1;
    conductivityArgs1.insert( std::make_pair( "temperature", temperatureInput ) );
    std::map<std::string, std::shared_ptr<std::vector<double>>> conductivityArgs0;
    std::map<std::string, std::shared_ptr<std::vector<double>>> viscosityArgs1;
    viscosityArgs1.insert( std::make_pair( "temperature", temperatureInput ) );
    std::map<std::string, std::shared_ptr<std::vector<double>>> viscosityArgs0;
    std::map<std::string, std::shared_ptr<std::vector<double>>> enthalpyArgs1;
    enthalpyArgs1.insert( std::make_pair( "temperature", temperatureInput ) );
    std::map<std::string, std::shared_ptr<std::vector<double>>> enthalpyArgs0;
