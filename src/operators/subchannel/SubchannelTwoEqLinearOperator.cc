...
double SubchannelTwoEqLinearOperator::dvdh( double h, double p )
{
    ...
    specificVolumeArgMap_pert.insert( std::make_pair(
        std::string( "enthalpy" ),
        AMP::shared_ptr<std::vector<double>>( new std::vector<double>( 1, h + pert ) ) ) );
    specificVolumeArgMap_pert.insert(
        std::make_pair( std::string( "pressure" ),
                        AMP::shared_ptr<std::vector<double>>( new std::vector<double>( 1, p ) ) ) );
    ...
    double h_minus, double p_minus, double h_plus, double p_plus, double mass, double A, double D )
{
    ...
    volumeArgMap_plus.insert( std::make_pair(
        std::string( "enthalpy" ),
        AMP::shared_ptr<std::vector<double>>( new std::vector<double>( 1, h_plus ) ) ) );
    volumeArgMap_plus.insert( std::make_pair(
        std::string( "pressure" ),
    ...
    volumeArgMap_minus.insert( std::make_pair(
        std::string( "enthalpy" ),
        AMP::shared_ptr<std::vector<double>>( new std::vector<double>( 1, h_minus ) ) ) );
    volumeArgMap_minus.insert( std::make_pair(
        std::string( "pressure" ),
    ...
    temperatureArgMap.insert( std::make_pair(
        std::string( "enthalpy" ),
    ...
    viscosityArgMap.insert( std::make_pair(
        std::string( "temperature" ),
        AMP::shared_ptr<std::vector<double>>( new std::vector<double>( 1, T_avg ) ) ) );
    viscosityArgMap.insert( std::make_pair(
        std::string( "density" ),
        AMP::shared_ptr<std::vector<double>>( new std::vector<double>( 1, rho_avg ) ) ) );
