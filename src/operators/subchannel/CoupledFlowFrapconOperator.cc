...
CoupledFlowFrapconOperator::CoupledFlowFrapconOperator(const AMP::shared_ptr<OperatorParameters>& params)
  : ColumnOperator(params)
{
      d_Mesh = params->d_Mesh;
      AMP::shared_ptr<CoupledFlowFrapconOperatorParameters> myparams = AMP::dynamic_pointer_cast<CoupledFlowFrapconOperatorParameters>(params);
      ...
      mapflowInternal3to1Params->d_Mesh    = (AMP::dynamic_pointer_cast<AMP::Operator::Map3Dto1D> (myparams->d_Map3to1) )->getMesh();
      mapflowInternal3to1Params->d_MapMesh = (AMP::dynamic_pointer_cast<AMP::Operator::Map3Dto1D> (myparams->d_Map3to1) )->getMesh();
      ...
      mapflowInternal1to3Params->d_Mesh    = (AMP::dynamic_pointer_cast<AMP::Operator::Map3Dto1D> (myparams->d_Map3to1) )->getMesh();
      mapflowInternal1to3Params->d_MapMesh = (AMP::dynamic_pointer_cast<AMP::Operator::Map3Dto1D> (myparams->d_Map3to1) )->getMesh();
      ...
      const double a, const double b)
{
        ...
        //AMP::LinearAlgebra::Variable::shared_ptr inpVar = (AMP::dynamic_pointer_cast<AMP::Operator::Map1Dto3D> (d_Operators[3]) )->getOutputVariable();
