...
public:
    ...
    double getExactSolutionY( double x, double y, double z ) const
    {
        return My * ( byx + ( ayx * x ) / Lx ) * ( byy + ( ayy * y ) / Ly ) *
               ( byz + ( ayz * z ) / Lz );
    }
    double getExactSolutionZ( double x, double y, double z ) const
    {
        return Mz * ( bzx + ( azx * x ) / Lx ) * ( bzy + ( azy * y ) / Ly ) *
               ( bzz + ( azz * z ) / Lz );
    }
    double getForcingTermX( double /* x */, double y, double z ) const
    {
    ...
    double getForcingTermY( double x, double /* y */, double z ) const
    {
    ...
    double getForcingTermZ( double x, double y, double /* z */ ) const
    {
    ...
    std::vector<double> getStressTensor( double x, double y, double z ) const
    {
