...
********************************************************************/
void UnitTest::pack_message_stream( const std::vector<std::string>& messages, const int rank, const int tag ) const
{
...
*  Other functions                                                  *
********************************************************************/
int UnitTest::rank() const
{
    return comm.getRank();
}
int UnitTest::size() const
{
    return comm.getSize();
}
size_t UnitTest::NumPassGlobal() const
{
	return comm.sumReduce<size_t>(NumPassLocal());
}
size_t UnitTest::NumFailGlobal() const
{
	return comm.sumReduce<size_t>(NumFailLocal());
