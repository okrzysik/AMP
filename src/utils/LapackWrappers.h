...
public:
     ...
     * @param[in] INCY      The spacing between points in x
     */
    static inline void gemv( char TRANS,
                             int M,
                             int N,
                             T alpha,
                             const T *A,
     ...
     */
    static inline void
    ger( int N, int M, T alpha, const T *x, int INCX, const T *y, int INCY, T *A, int LDA );
     ...
     */
    static inline void
    gbsv( int N, int KL, int KU, int NRHS, T *AB, int LDAB, int *IPIV, T *B, int LDB, int &INFO );
     ...
     *                      < 0:  if INFO = -i, the i-th argument had an illegal value
     */
    static inline void getrs( char TRANS,
                              int N,
                              int NRHS,
                              const T *A,
                              int LDA,
     ...
     *                      < 0:  if INFO = -i, the i-th argument had an illegal value
     */
    static inline void gttrs( char TRANS,
                              int N,
                              int NRHS,
                              const T *DL,
                              const T *D,
     ...
     *                      < 0:  if INFO = -i, the i-th argument had an illegal value
     */
    static inline void gbtrs( char TRANS,
                              int N,
                              int KL,
                              int KU,
                              int NRHS,
     ...
     */
    static inline void
    getri( int N, T *A, int LDA, const int *IPIV, T *WORK, int LWORK, int &INFO );
     ...
     */
    static inline void trsm( char SIDE,
                             char UPLO,
                             char TRANS,
                             char DIAG,
                             int M,
