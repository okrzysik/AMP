...
template <>
inline void
Lapack<double>::axpy( int N, double DA, const double *DX, int INCX, double *DY, int INCY )
{
#ifdef USE_ATLAS
...
#undef dgemv
template <>
inline void Lapack<double>::gemv( char TRANS,
                                  int M,
                                  int N,
                                  double ALPHA,
                                  const double *A,
...
#undef dgemm
template <>
inline void Lapack<double>::gemm( char TRANSA,
                                  char TRANSB,
                                  int M,
                                  int N,
                                  int K,
...
#undef dger
template <>
inline void Lapack<double>::ger( int N,
                                 int M,
                                 double alpha,
                                 const double *x,
                                 int INCX,
...
#undef dgesv
template <>
inline void Lapack<double>::gesv(
...
#undef dgtsv
template <>
inline void Lapack<double>::gtsv(
...
#undef dgbsv
template <>
inline void Lapack<double>::gbsv( int N,
                                  int KL,
                                  int KU,
                                  int NRHS,
                                  double *AB,
...
template <>
inline void
Lapack<double>::gttrf( int N, double *DL, double *D, double *DU, double *DU2, int *IPIV, int &INFO )
{
#ifdef USE_ATLAS
...
template <>
inline void
Lapack<double>::gbtrf( int M, int N, int KL, int KU, double *AB, int LDAB, int *IPIV, int &INFO )
{
#ifdef USE_ATLAS
...
#undef dgetrs
template <>
inline void Lapack<double>::getrs( char TRANS,
                                   int N,
                                   int NRHS,
                                   const double *A,
                                   int LDA,
...
#undef dgttrs
template <>
inline void Lapack<double>::gttrs( char TRANS,
                                   int N,
                                   int NRHS,
                                   const double *DL,
                                   const double *D,
...
#undef dgbtrs
template <>
inline void Lapack<double>::gbtrs( char TRANS,
                                   int N,
                                   int KL,
                                   int KU,
                                   int NRHS,
...
#undef dgetri
template <>
inline void Lapack<double>::getri(
...
#undef dtrsm
template <>
inline void Lapack<double>::trsm( char SIDE,
                                  char UPLO,
                                  char TRANS,
                                  char DIAG,
                                  int M,
