#ifndef USE_LAPACK_DOUBLE_WRAPPER_HPP
#define USE_LAPACK_DOUBLE_WRAPPER_HPP
...
#undef dgemv
template <>
inline void Lapack<double>::gemv( char TRANS, int M, int N, double ALPHA, 
...
#undef dgemm
template <>
inline void Lapack<double>::gemm( char TRANSA, char TRANSB, int M, int N, int K, double ALPHA, 
...
#undef dger
template <>
inline void Lapack<double>::ger( int N, int M, double alpha, const double *x, int INCX, const double *y, int INCY, double *A, int LDA )
{
    #ifdef USE_ATLAS
...
#undef dgbsv
template <>
inline void Lapack<double>::gbsv( int N, int KL, int KU, int NRHS, double *AB, int LDAB, int *IPIV, double *B, int LDB, int &INFO )
{
    #ifdef USE_ATLAS
...
#undef dgetrs
template <>
inline void Lapack<double>::getrs( char TRANS, int N, int NRHS, const double *A, int LDA, const int *IPIV, double *B, int LDB, int &INFO )
{
    #ifdef USE_ATLAS
...
#undef dgttrs
template <>
inline void Lapack<double>::gttrs( char TRANS, int N, int NRHS, const double *DL, const double *D,
...
#undef dgbtrs
template <>
inline void Lapack<double>::gbtrs( char TRANS, int N, int KL, int KU, int NRHS, const double *AB, 
...
#undef dtrsm
template <>
inline void Lapack<double>::trsm( char SIDE, char UPLO, char TRANS, char DIAG,
        int M, int N, double ALPHA, const double *A, int LDA, double *B, int LDB )
{
    ...
    #elif defined(USE_VECLIB)
        cblas_dtrsm(CblasColMajor,SIDE2(SIDE),UPLO2(UPLO),TRANS2(TRANS),DIAG2(DIAG),M,N,ALPHA,(double*)A,LDA,B,LDB);
    #elif defined(USE_MATLAB_LAPACK)
