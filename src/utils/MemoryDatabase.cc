//
// File:	$URL: file:///usr/casc/samrai/repository/AMP/tags/v-2-4-4/source/toolbox/database/MemoryDatabase.C $
// Package:	AMP toolbox
...
namespace AMP {
  ...
  */
  ...
  void MemoryDatabase::putBoolArray(
      const std::string& key, const unsigned char* const data, const int nelements)
  {
    deleteKeyIfFound(key);
    KeyData keydata;
    keydata.d_key          = key;
  ...
  */
  ...
  void MemoryDatabase::putComplexArray(
      const std::string& key, const std::complex< double >* const data, const int nelements)
  {
    deleteKeyIfFound(key);
    KeyData keydata;
    keydata.d_key          = key;
  ...
  std::complex< double > MemoryDatabase::getComplexWithDefault(
  ...
  std::vector<std::complex< double > > MemoryDatabase::getComplexArray(
...
#pragma warning (disable:810)
  ...
  std::vector<float> MemoryDatabase::getFloatArray(
      const std::string& key)
  {
    KeyData *keydata = findKeyDataOrExit(key);
  ...
  */
  ...
  std::vector<int> MemoryDatabase::getIntegerArray(
      const std::string& key)
  {
    KeyData *keydata = findKeyDataOrExit(key);
  ...
  */
  ...
  void MemoryDatabase::printDatabase(
      std::ostream& , const int , const int ) const
  {
