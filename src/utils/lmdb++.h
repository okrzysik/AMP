 ...
 * dropped into AMP on May 18, 2016 based on the repo version of the day, BP
 */
...
public:
     ...
     */
    const char *origin() const noexcept { return runtime_error::what(); }
...
static inline void env_open( MDB_env *env, const char *path, unsigned int flags, mode mode );
 ...
 */
static inline void LMDB::env_create( MDB_env **env )
{
 ...
 */
static inline void LMDB::env_open( MDB_env *const env,
 ...
 */
static inline void LMDB::env_copy( MDB_env *const env,
#if MDB_VERSION_FULL >= MDB_VERINT( 0, 9, 14 )
                                   const char *const path,
 ...
 */
static inline void LMDB::env_copy_fd( MDB_env *const env,
#if MDB_VERSION_FULL >= MDB_VERINT( 0, 9, 14 )
 ...
 */
static inline void LMDB::env_stat( MDB_env *const env, MDB_stat *const stat )
{
 ...
 */
static inline void LMDB::env_info( MDB_env *const env, MDB_envinfo *const stat )
{
 ...
 */
static inline void LMDB::env_sync( MDB_env *const env, const bool force = true )
{
 ...
 */
static inline void
LMDB::env_set_flags( MDB_env *const env, const unsigned int flags, const bool onoff = true )
{
 ...
 */
static inline void LMDB::env_get_path( MDB_env *const env, const char **path )
{
 ...
 */
static inline void LMDB::env_get_fd( MDB_env *const env, mdb_filehandle_t *const fd )
{
 ...
 */
static inline void LMDB::env_set_mapsize( MDB_env *const env, const std::size_t size )
{
 ...
 */
static inline void LMDB::env_set_max_readers( MDB_env *const env, const unsigned int count )
{
 ...
 */
static inline void LMDB::env_get_max_readers( MDB_env *const env, unsigned int *const count )
{
 ...
 */
static inline void LMDB::env_set_max_dbs( MDB_env *const env, const MDB_dbi count )
{
 ...
 */
static inline unsigned int LMDB::env_get_max_keysize( MDB_env *const env )
{
 ...
 */
static inline void LMDB::env_set_userctx( MDB_env *const env, void *const ctx )
{
 ...
 */
static inline void *LMDB::env_get_userctx( MDB_env *const env )
{
...
namespace LMDB {
static inline void txn_begin( MDB_env *env, MDB_txn *parent, unsigned int flags, MDB_txn **txn );
 ...
 */
static inline void LMDB::txn_begin( MDB_env *const env,
 ...
 */
static inline MDB_env *LMDB::txn_env( MDB_txn *const txn ) noexcept { return ::mdb_txn_env( txn ); }

#ifdef LMDBXX_TXN_ID
/**
 * @note Only available in HEAD, not yet in any 0.9.x release (as of 0.9.16).
 */
static inline std::size_t LMDB::txn_id( MDB_txn *const txn ) noexcept
{
 ...
 */
static inline void LMDB::txn_commit( MDB_txn *const txn )
{
 ...
 */
static inline void LMDB::txn_abort( MDB_txn *const txn ) noexcept { ::mdb_txn_abort( txn ); }

/**
 * @see http://symas.com/mdb/doc/group__mdb.html#ga02b06706f8a66249769503c4e88c56cd
 */
static inline void LMDB::txn_reset( MDB_txn *const txn ) noexcept { ::mdb_txn_reset( txn ); }

/**
 * @throws LMDB::error on failure
 * @see http://symas.com/mdb/doc/group__mdb.html#ga6c6f917959517ede1c504cf7c720ce6d
 */
static inline void LMDB::txn_renew( MDB_txn *const txn )
{
...
namespace LMDB {
static inline void dbi_open( MDB_txn *txn, const char *name, unsigned int flags, MDB_dbi *dbi );
...
static inline bool
dbi_put( MDB_txn *txn, MDB_dbi dbi, const MDB_val *key, MDB_val *data, unsigned int flags );
 ...
 */
static inline void LMDB::dbi_open( MDB_txn *const txn,
 ...
 */
static inline void LMDB::dbi_stat( MDB_txn *const txn, const MDB_dbi dbi, MDB_stat *const result )
{
 ...
 */
static inline void
LMDB::dbi_flags( MDB_txn *const txn, const MDB_dbi dbi, unsigned int *const flags )
{
 ...
 */
static inline void LMDB::dbi_close( MDB_env *const env, const MDB_dbi dbi ) noexcept
{
 ...
 */
static inline void LMDB::dbi_drop( MDB_txn *const txn, const MDB_dbi dbi, const bool del = false )
{
 ...
 */
static inline void
LMDB::dbi_set_compare( MDB_txn *const txn, const MDB_dbi dbi, MDB_cmp_func *const cmp = nullptr )
{
 ...
 */
static inline void
LMDB::dbi_set_dupsort( MDB_txn *const txn, const MDB_dbi dbi, MDB_cmp_func *const cmp = nullptr )
{
 ...
 */
static inline void
LMDB::dbi_set_relfunc( MDB_txn *const txn, const MDB_dbi dbi, MDB_rel_func *const rel )
{
 ...
 */
static inline void LMDB::dbi_set_relctx( MDB_txn *const txn, const MDB_dbi dbi, void *const ctx )
{
 ...
 */
static inline bool LMDB::dbi_get( MDB_txn *const txn,
                                  const MDB_dbi dbi,
 ...
 */
static inline bool LMDB::dbi_put( MDB_txn *const txn,
                                  const MDB_dbi dbi,
                                  const MDB_val *const key,
                                  MDB_val *const data,
                                  const unsigned int flags = 0 )
 ...
 */
static inline bool LMDB::dbi_del( MDB_txn *const txn,
                                  const MDB_dbi dbi,
                                  const MDB_val *const key,
                                  const MDB_val *const data = nullptr )
{
    const int rc =
        ::mdb_del( txn, dbi, const_cast<MDB_val *>( key ), const_cast<MDB_val *>( data ) );
    if ( rc != MDB_SUCCESS && rc != MDB_NOTFOUND ) {
 ...
 */
static inline void
LMDB::cursor_open( MDB_txn *const txn, const MDB_dbi dbi, MDB_cursor **const cursor )
{
 ...
 */
static inline void LMDB::cursor_close( MDB_cursor *const cursor ) noexcept
{
 ...
 */
static inline void LMDB::cursor_renew( MDB_txn *const txn, MDB_cursor *const cursor )
{
 ...
 */
static inline MDB_txn *LMDB::cursor_txn( MDB_cursor *const cursor ) noexcept
{
 ...
 */
static inline MDB_dbi LMDB::cursor_dbi( MDB_cursor *const cursor ) noexcept
{
 ...
 */
static inline bool LMDB::cursor_get( MDB_cursor *const cursor,
                                     MDB_val *const key,
                                     MDB_val *const data,
 ...
 */
static inline void LMDB::cursor_put( MDB_cursor *const cursor,
                                     MDB_val *const key,
                                     MDB_val *const data,
                                     const unsigned int flags = 0 )
{
 ...
 */
static inline void LMDB::cursor_del( MDB_cursor *const cursor, const unsigned int flags = 0 )
{
 ...
 */
static inline void LMDB::cursor_count( MDB_cursor *const cursor, std::size_t &count )
{
...
public:
     ...
     */
    operator MDB_val *() noexcept { return &_val; }

    /**
     * Returns an `MDB_val*` pointer.
     */
    operator const MDB_val *() const noexcept { return &_val; }
     ...
     */
    std::size_t size() const noexcept { return _val.mv_size; }
     ...
     * Returns a pointer to the data.
     */
    char *data() noexcept { return reinterpret_cast<char *>( _val.mv_data ); }

    /**
     * Returns a pointer to the data.
     */
    const char *data() const noexcept { return reinterpret_cast<char *>( _val.mv_data ); }
     ...
     * Assigns the value.
     */
    val &assign( const char *const data ) noexcept { return assign( data, std::strlen( data ) ); }

    /**
     * Assigns the value.
     */
    val &assign( const std::string &data ) noexcept { return assign( data.data(), data.size() ); }
};
...
public:
     ...
     * Move constructor.
     */
    env( env &&other ) noexcept { std::swap( _handle, other._handle ); }
     ...
     */
    operator MDB_env *() const noexcept { return _handle; }

    /**
     * Returns the underlying `MDB_env*` handle.
     */
    MDB_env *handle() const noexcept { return _handle; }
     ...
     * @throws LMDB::error on failure
     */
    void sync( const bool force = true ) { LMDB::env_sync( handle(), force ); }
...
public:
     ...
     * Move constructor.
     */
    txn( txn &&other ) noexcept { std::swap( _handle, other._handle ); }
     ...
     */
    operator MDB_txn *() const noexcept { return _handle; }

    /**
     * Returns the underlying `MDB_txn*` handle.
     */
    MDB_txn *handle() const noexcept { return _handle; }

    /**
     * Returns the transaction's `MDB_env*` handle.
     */
    MDB_env *env() const noexcept { return LMDB::txn_env( handle() ); }
     ...
     */
    void reset() noexcept { LMDB::txn_reset( _handle ); }
     ...
     * @throws LMDB::error on failure
     */
    void renew() { LMDB::txn_renew( _handle ); }
};
...
public:
     ...
     * @throws LMDB::error on failure
     */
    static dbi open( MDB_txn *const txn,
     ...
     * Move constructor.
     */
    dbi( dbi &&other ) noexcept { std::swap( _handle, other._handle ); }
     ...
     */
    operator MDB_dbi() const noexcept { return _handle; }

    /**
     * Returns the underlying `MDB_dbi` handle.
     */
    MDB_dbi handle() const noexcept { return _handle; }
     ...
     * @throws LMDB::error on failure
     */
    std::size_t size( MDB_txn *const txn ) const { return stat( txn ).ms_entries; }
     ...
     * @throws LMDB::error on failure
     */
    bool del( MDB_txn *const txn, const val &key ) { return LMDB::dbi_del( txn, handle(), key ); }
...
public:
     ...
     * Move constructor.
     */
    cursor( cursor &&other ) noexcept { std::swap( _handle, other._handle ); }
     ...
     */
    operator MDB_cursor *() const noexcept { return _handle; }

    /**
     * Returns the underlying `MDB_cursor*` handle.
     */
    MDB_cursor *handle() const noexcept { return _handle; }
     ...
     * @throws LMDB::error on failure
     */
    void renew( MDB_txn *const txn ) { LMDB::cursor_renew( txn, handle() ); }

    /**
     * Returns the cursor's transaction handle.
     */
    MDB_txn *txn() const noexcept { return LMDB::cursor_txn( handle() ); }

    /**
     * Returns the cursor's database handle.
     */
    MDB_dbi dbi() const noexcept { return LMDB::cursor_dbi( handle() ); }
     ...
     * @throws LMDB::error on failure
     */
    bool get( MDB_val *const key, const MDB_cursor_op op ) { return get( key, nullptr, op ); }
     ...
     * @throws LMDB::error on failure
     */
    bool get( LMDB::val &key, const MDB_cursor_op op ) { return get( key, nullptr, op ); }
