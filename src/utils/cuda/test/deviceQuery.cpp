...
int main( int argc, char **argv )
{
    ...
    snprintf( cTemp, 5*sizeof(char), "%2lu.%1lu", ( driverVersion / 1000 )%100lu, ( ( driverVersion % 100 ) / 10 )%10lu);
    sProfileString += cTemp;

    // Runtime version
    sProfileString += ", CUDA Runtime Version = ";
    snprintf( cTemp, 5*sizeof(char), "%2lu.%1lu", ( runtimeVersion / 1000 )%100lu, ( ( runtimeVersion % 100 ) / 10  )%10lu );
    sProfileString += cTemp;
