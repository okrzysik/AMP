...
template <class TYPE, class FUN, class ALLOC>
void GPUFunctionTable::transformHardTanh(const Array<TYPE, FUN, ALLOC> &A, Array<TYPE, FUN, ALLOC> &B)
{
    B.resize(A.size());
...
template <class TYPE, class FUN, class ALLOC>
void GPUFunctionTable::transformSigmoid(const Array<TYPE, FUN, ALLOC> &A, Array<TYPE, FUN, ALLOC> &B)
{
    B.resize(A.size());
...
template <class TYPE, class FUN, class ALLOC>
void GPUFunctionTable::transformSoftPlus(const Array<TYPE, FUN, ALLOC> &A, Array<TYPE, FUN, ALLOC> &B)
{
    B.resize(A.size());
...
template <class TYPE, class FUN, class ALLOC>
bool GPUFunctionTable::equals( const Array<TYPE, FUN, ALLOC> &A, const Array<TYPE, FUN, ALLOC> &B, TYPE tol )
{
    bool eq = true;
...
template <class TYPE>
inline void gemmWrapper(char TRANSA, char TRANSB, int M, int N, int K, TYPE alpha, const TYPE* A, int LDA, const TYPE* B, int LDB, TYPE beta, TYPE* C, int LDC)
{
    AMP_ERROR("Not supported for the provided type");
}

template <>
inline void gemmWrapper<float>(char TRANSA, char TRANSB, int M, int N, int K, float alpha, const float* A, int LDA, const float* B, int LDB, float beta, float* C, int LDC)
{
...
template <>
inline void gemmWrapper<double>(char TRANSA, char TRANSB, int M, int N, int K,double alpha, const double* A, int LDA, const double* B, int LDB, double beta, double* C, int LDC)
{
...
inline void GPUFunctionTable::transform(LAMBDA &fun, const Array<TYPE,FUN,ALLOC> &x, Array<TYPE,FUN,ALLOC> &y)
{
    AMP_ERROR("Not implemented for GPU");
}

template <class TYPE, class FUN, class ALLOC, typename LAMBDA>
inline void GPUFunctionTable::transform(LAMBDA &fun, const Array<TYPE,FUN,ALLOC> &x, const Array<TYPE,FUN,ALLOC> &y, Array<TYPE,FUN,ALLOC> &z)
{
    AMP_ERROR("Not implemented for GPU");
}
...
template <class TYPE, class FUN, class ALLOC>
void GPUFunctionTable::multiply( const Array<TYPE, FUN, ALLOC> &a, const Array<TYPE, FUN, ALLOC> &b, Array<TYPE, FUN, ALLOC> &c)
{
