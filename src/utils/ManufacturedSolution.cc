...
void ManufacturedSolution::quad_neumann(
		...
		const valarray<double> &c, const valarray<double> &a)
{
    #ifdef DBC
        size_t na=1;
        size_t nc=6;
        ...
        AMP_INSIST(poly.size()>=10, "input size of argument poly must be at least 10");
    #endif

    poly[0] = a[0] + x*(-c[0] + x*(c[0]/2 + c[1]/2)) + y*(-c[2] + y*(c[2]/2 + c[3]/2)) + z*(-c[4] + z*(c[4]/2 + c[5]/2));
    poly[1] = -c[0] + x*(c[0] + c[1]);
    poly[2] = -c[2] + y*(c[2] + c[3]);
    poly[3] = -c[4] + z*(c[4] + c[5]);
    poly[4] = c[0] + c[1];
    poly[5] = 0;
    poly[6] = 0;
    poly[7] = c[2] + c[3];
		...
		const valarray<double> &c, const valarray<double> &a)
{
    ...
    poly[0] = c[0] + x*(a[0] + x*(-a[0]/2 + c[1]/2));
    poly[1] = a[0] + x*(-a[0] + c[1]);
    poly[2] = 0;
    poly[3] = 0;
    poly[4] = -a[0] + c[1];
    poly[5] = 0;
		...
		const valarray<double> &c, const valarray<double> &a)
{
    ...
    poly[0] = c[0] + x*(a[0] + x*(-a[0] - c[0] + c[1]));
    poly[1] = a[0] + x*(-2*a[0] - 2*c[0] + 2*c[1]);
    poly[2] = 0;
    poly[3] = 0;
    poly[4] = -2*a[0] - 2*c[0] + 2*c[1];
    poly[5] = 0;
    poly[6] = 0;
    poly[7] = 0;
    poly[8] = 0;
...
void ManufacturedSolution::quad_none(valarray<double> &poly, const double x, const double y,
		const double z, const valarray<double> &c, const valarray<double> &a)
{
    #ifdef DBC
        size_t na=10;
        size_t nc=0;
    ...
    poly[0] = a[0] + z*(a[1] + z*a[2]) + y*(a[3] + z*a[4] + y*a[5]) + x*(a[6] + z*a[7] + y*a[8] + x*a[9]);
    poly[1] = a[6] + z*a[7] + y*a[8] + 2*x*a[9];
    poly[2] = a[3] + z*a[4] + 2*y*a[5] + x*a[8];
    poly[3] = a[1] + 2*z*a[2] + y*a[4] + x*a[7];
    poly[4] = 2*a[9];
    poly[5] = a[8];
    poly[6] = a[7];
    poly[7] = 2*a[5];
		...
		const valarray<double> &c, const valarray<double> &a)
{
    ...
    poly[0] = a[0] + x*(-c[0] + x*(a[4] + z*z*(a[5] - (2*z*a[5])/3) + y*y*(a[6] + z*z*(a[7] - (2*z*a[7])/3) + y*((-2*a[6])/3 + z*z*((-2*a[7])/3 + (4*z*a[7])/9))) + x*((-2*a[4])/3 + z*z*((-2*a[5])/3 + (4*z*a[5])/9) + y*y*((-2*a[6])/3 + z*z*((-2*a[7])/3 + (4*z*a[7])/9) + y*((4*a[6])/9 + z*z*((4*a[7])/9 - (8*z*a[7])/27))) + c[0]/3 + c[1]/3))) + y*(-c[2] + y*(a[2] + z*z*(a[3] - (2*z*a[3])/3) + y*((-2*a[2])/3 + z*z*((-2*a[3])/3 + (4*z*a[3])/9) + c[2]/3 + c[3]/3))) + z*(-c[4] + z*(a[1] + z*((-2*a[1])/3 + c[4]/3 + c[5]/3)));
    poly[1] = -c[0] + x*(2*a[4] + z*z*(2*a[5] - (4*z*a[5])/3) + y*y*(2*a[6] + z*z*(2*a[7] - (4*z*a[7])/3) + y*((-4*a[6])/3 + z*z*((-4*a[7])/3 + (8*z*a[7])/9))) + x*(-2*a[4] + z*z*(-2*a[5] + (4*z*a[5])/3) + y*y*(-2*a[6] + z*z*(-2*a[7] + (4*z*a[7])/3) + y*((4*a[6])/3 + z*z*((4*a[7])/3 - (8*z*a[7])/9))) + c[0] + c[1]));
    poly[2] = x*x*(x*y*((-4*a[6])/3 + z*z*((-4*a[7])/3 + (8*z*a[7])/9) + y*((4*a[6])/3 + z*z*((4*a[7])/3 - (8*z*a[7])/9))) + y*(2*a[6] + z*z*(2*a[7] - (4*z*a[7])/3) + y*(-2*a[6] + z*z*(-2*a[7] + (4*z*a[7])/3)))) - c[2] + y*(2*a[2] + z*z*(2*a[3] - (4*z*a[3])/3) + y*(-2*a[2] + z*z*(-2*a[3] + (4*z*a[3])/3) + c[2] + c[3]));
    poly[3] = y*y*(z*(2*a[3] - 2*z*a[3]) + y*z*((-4*a[3])/3 + (4*z*a[3])/3)) + x*x*(z*(2*a[5] - 2*z*a[5]) + y*y*(z*(2*a[7] - 2*z*a[7]) + y*z*((-4*a[7])/3 + (4*z*a[7])/3)) + x*(z*((-4*a[5])/3 + (4*z*a[5])/3) + y*y*(y*z*((8*a[7])/9 - (8*z*a[7])/9) + z*((-4*a[7])/3 + (4*z*a[7])/3)))) - c[4] + z*(2*a[1] + z*(-2*a[1] + c[4] + c[5]));
    poly[4] = 2*a[4] + z*z*(2*a[5] - (4*z*a[5])/3) + y*y*(2*a[6] + z*z*(2*a[7] - (4*z*a[7])/3) + y*((-4*a[6])/3 + z*z*((-4*a[7])/3 + (8*z*a[7])/9))) + x*(-4*a[4] + z*z*(-4*a[5] + (8*z*a[5])/3) + y*y*(-4*a[6] + z*z*(-4*a[7] + (8*z*a[7])/3) + y*((8*a[6])/3 + z*z*((8*a[7])/3 - (16*z*a[7])/9))) + 2*c[0] + 2*c[1]);
    poly[5] = x*(x*y*(-4*a[6] + z*z*(-4*a[7] + (8*z*a[7])/3) + y*(4*a[6] + z*z*(4*a[7] - (8*z*a[7])/3))) + y*(4*a[6] + z*z*(4*a[7] - (8*z*a[7])/3) + y*(-4*a[6] + z*z*(-4*a[7] + (8*z*a[7])/3))));
    poly[6] = x*(z*(4*a[5] - 4*z*a[5]) + y*y*(z*(4*a[7] - 4*z*a[7]) + y*z*((-8*a[7])/3 + (8*z*a[7])/3)) + x*(z*(-4*a[5] + 4*z*a[5]) + y*y*(y*z*((8*a[7])/3 - (8*z*a[7])/3) + z*(-4*a[7] + 4*z*a[7]))));
    poly[7] = 2*a[2] + z*z*(2*a[3] - (4*z*a[3])/3) + x*x*(2*a[6] + z*z*(2*a[7] - (4*z*a[7])/3) + y*(-4*a[6] + z*z*(-4*a[7] + (8*z*a[7])/3)) + x*((-4*a[6])/3 + z*z*((-4*a[7])/3 + (8*z*a[7])/9) + y*((8*a[6])/3 + z*z*((8*a[7])/3 - (16*z*a[7])/9)))) + y*(-4*a[2] + z*z*(-4*a[3] + (8*z*a[3])/3) + 2*c[2] + 2*c[3]);
    poly[8] = y*(z*(4*a[3] - 4*z*a[3]) + y*z*(-4*a[3] + 4*z*a[3])) + x*x*(x*y*(y*z*((8*a[7])/3 - (8*z*a[7])/3) + z*((-8*a[7])/3 + (8*z*a[7])/3)) + y*(z*(4*a[7] - 4*z*a[7]) + y*z*(-4*a[7] + 4*z*a[7])));
    poly[9] = 2*a[1] + y*y*(2*a[3] - 4*z*a[3] + y*((-4*a[3])/3 + (8*z*a[3])/3)) + x*x*(2*a[5] - 4*z*a[5] + y*y*(2*a[7] - 4*z*a[7] + y*((-4*a[7])/3 + (8*z*a[7])/3)) + x*((-4*a[5])/3 + (8*z*a[5])/3 + y*y*((-4*a[7])/3 + (8*z*a[7])/3 + y*((8*a[7])/9 - (16*z*a[7])/9)))) + z*(-4*a[1] + 2*c[4] + 2*c[5]);
}
		...
		const valarray<double> &c, const valarray<double> &a)
{
    ...
    poly[0] = c[0] + x*(a[0] + z*z*(a[1] - (2*z*a[1])/3) + y*y*(a[2] + z*z*(a[3] - (2*z*a[3])/3) + y*((-2*a[2])/3 + z*z*((-2*a[3])/3 + (4*z*a[3])/9))) + x*(a[4] + z*z*(a[5] - (2*z*a[5])/3) + y*y*(a[6] + z*z*(a[7] - (2*z*a[7])/3) + y*((-2*a[6])/3 + z*z*((-2*a[7])/3 + (4*z*a[7])/9))) + x*(-a[0]/3 - (2*a[4])/3 + z*z*(-a[1]/3 + z*((2*a[1])/9 + (4*a[5])/9) - (2*a[5])/3) + y*y*(-a[2]/3 - (2*a[6])/3 + y*((2*a[2])/9 + (4*a[6])/9 + z*z*((2*a[3])/9 + z*((-4*a[3])/27 - (8*a[7])/27) + (4*a[7])/9)) + z*z*(-a[3]/3 + z*((2*a[3])/9 + (4*a[7])/9) - (2*a[7])/3)) + c[1]/3)));
    poly[1] = a[0] + z*z*(a[1] - (2*z*a[1])/3) + y*y*(a[2] + z*z*(a[3] - (2*z*a[3])/3) + y*((-2*a[2])/3 + z*z*((-2*a[3])/3 + (4*z*a[3])/9))) + x*(2*a[4] + z*z*(2*a[5] - (4*z*a[5])/3) + y*y*(2*a[6] + z*z*(2*a[7] - (4*z*a[7])/3) + y*((-4*a[6])/3 + z*z*((-4*a[7])/3 + (8*z*a[7])/9))) + x*(-a[0] - 2*a[4] + z*z*(-a[1] - 2*a[5] + z*((2*a[1])/3 + (4*a[5])/3)) + y*y*(-a[2] - 2*a[6] + z*z*(-a[3] - 2*a[7] + z*((2*a[3])/3 + (4*a[7])/3)) + y*((2*a[2])/3 + (4*a[6])/3 + z*z*((2*a[3])/3 + z*((-4*a[3])/9 - (8*a[7])/9) + (4*a[7])/3))) + c[1]));
    poly[2] = x*(y*(2*a[2] + z*z*(2*a[3] - (4*z*a[3])/3) + y*(-2*a[2] + z*z*(-2*a[3] + (4*z*a[3])/3))) + x*(x*y*((-2*a[2])/3 - (4*a[6])/3 + z*z*((-2*a[3])/3 + z*((4*a[3])/9 + (8*a[7])/9) - (4*a[7])/3) + y*((2*a[2])/3 + (4*a[6])/3 + z*z*((2*a[3])/3 + z*((-4*a[3])/9 - (8*a[7])/9) + (4*a[7])/3))) + y*(2*a[6] + z*z*(2*a[7] - (4*z*a[7])/3) + y*(-2*a[6] + z*z*(-2*a[7] + (4*z*a[7])/3)))));
    poly[3] = x*(z*(2*a[1] - 2*z*a[1]) + y*y*(z*(2*a[3] - 2*z*a[3]) + y*z*((-4*a[3])/3 + (4*z*a[3])/3)) + x*(z*(2*a[5] - 2*z*a[5]) + y*y*(z*(2*a[7] - 2*z*a[7]) + y*z*((-4*a[7])/3 + (4*z*a[7])/3)) + x*(z*((-2*a[1])/3 - (4*a[5])/3 + z*((2*a[1])/3 + (4*a[5])/3)) + y*y*(y*z*((4*a[3])/9 + z*((-4*a[3])/9 - (8*a[7])/9) + (8*a[7])/9) + z*((-2*a[3])/3 - (4*a[7])/3 + z*((2*a[3])/3 + (4*a[7])/3))))));
    poly[4] = 2*a[4] + z*z*(2*a[5] - (4*z*a[5])/3) + y*y*(2*a[6] + z*z*(2*a[7] - (4*z*a[7])/3) + y*((-4*a[6])/3 + z*z*((-4*a[7])/3 + (8*z*a[7])/9))) + x*(-2*a[0] - 4*a[4] + z*z*(-2*a[1] - 4*a[5] + z*((4*a[1])/3 + (8*a[5])/3)) + y*y*(-2*a[2] - 4*a[6] + z*z*(-2*a[3] - 4*a[7] + z*((4*a[3])/3 + (8*a[7])/3)) + y*((4*a[2])/3 + (8*a[6])/3 + z*z*((4*a[3])/3 + z*((-8*a[3])/9 - (16*a[7])/9) + (8*a[7])/3))) + 2*c[1]);
    poly[5] = y*(2*a[2] + z*z*(2*a[3] - (4*z*a[3])/3) + y*(-2*a[2] + z*z*(-2*a[3] + (4*z*a[3])/3))) + x*(x*y*(-2*a[2] - 4*a[6] + z*z*(-2*a[3] - 4*a[7] + z*((4*a[3])/3 + (8*a[7])/3)) + y*(2*a[2] + 4*a[6] + z*z*(2*a[3] + z*((-4*a[3])/3 - (8*a[7])/3) + 4*a[7]))) + y*(4*a[6] + z*z*(4*a[7] - (8*z*a[7])/3) + y*(-4*a[6] + z*z*(-4*a[7] + (8*z*a[7])/3))));
    poly[6] = z*(2*a[1] - 2*z*a[1]) + y*y*(z*(2*a[3] - 2*z*a[3]) + y*z*((-4*a[3])/3 + (4*z*a[3])/3)) + x*(z*(4*a[5] - 4*z*a[5]) + y*y*(z*(4*a[7] - 4*z*a[7]) + y*z*((-8*a[7])/3 + (8*z*a[7])/3)) + x*(z*(-2*a[1] - 4*a[5] + z*(2*a[1] + 4*a[5])) + y*y*(y*z*((4*a[3])/3 + z*((-4*a[3])/3 - (8*a[7])/3) + (8*a[7])/3) + z*(-2*a[3] - 4*a[7] + z*(2*a[3] + 4*a[7])))));
    poly[7] = x*(2*a[2] + z*z*(2*a[3] - (4*z*a[3])/3) + y*(-4*a[2] + z*z*(-4*a[3] + (8*z*a[3])/3)) + x*(2*a[6] + z*z*(2*a[7] - (4*z*a[7])/3) + y*(-4*a[6] + z*z*(-4*a[7] + (8*z*a[7])/3)) + x*((-2*a[2])/3 - (4*a[6])/3 + z*z*((-2*a[3])/3 + z*((4*a[3])/9 + (8*a[7])/9) - (4*a[7])/3) + y*((4*a[2])/3 + (8*a[6])/3 + z*z*((4*a[3])/3 + z*((-8*a[3])/9 - (16*a[7])/9) + (8*a[7])/3)))));
    poly[8] = x*(y*(z*(4*a[3] - 4*z*a[3]) + y*z*(-4*a[3] + 4*z*a[3])) + x*(y*(z*(4*a[7] - 4*z*a[7]) + y*z*(-4*a[7] + 4*z*a[7])) + x*y*(y*z*((4*a[3])/3 + z*((-4*a[3])/3 - (8*a[7])/3) + (8*a[7])/3) + z*((-4*a[3])/3 - (8*a[7])/3 + z*((4*a[3])/3 + (8*a[7])/3)))));
    poly[9] = x*(2*a[1] - 4*z*a[1] + y*y*(2*a[3] - 4*z*a[3] + y*((-4*a[3])/3 + (8*z*a[3])/3)) + x*(2*a[5] - 4*z*a[5] + y*y*(2*a[7] - 4*z*a[7] + y*((-4*a[7])/3 + (8*z*a[7])/3)) + x*((-2*a[1])/3 - (4*a[5])/3 + z*((4*a[1])/3 + (8*a[5])/3) + y*y*((-2*a[3])/3 + y*((4*a[3])/9 + z*((-8*a[3])/9 - (16*a[7])/9) + (8*a[7])/9) - (4*a[7])/3 + z*((4*a[3])/3 + (8*a[7])/3)))));
}
		...
		const valarray<double> &c, const valarray<double> &a)
{
    ...
    poly[2] = x*(y*(2*a[2] + z*z*(2*a[3] - (4*z*a[3])/3) + y*(-2*a[2] + z*z*(-2*a[3] + (4*z*a[3])/3))) + x*(x*y*(-2*a[2] - 2*a[6] + z*z*(-2*a[3] - 2*a[7] + z*((4*a[3])/3 + (4*a[7])/3)) + y*(2*a[2] + 2*a[6] + z*z*(2*a[3] + z*((-4*a[3])/3 - (4*a[7])/3) + 2*a[7]))) + y*(2*a[6] + z*z*(2*a[7] - (4*z*a[7])/3) + y*(-2*a[6] + z*z*(-2*a[7] + (4*z*a[7])/3)))));
    poly[3] = x*(z*(2*a[1] - 2*z*a[1]) + y*y*(z*(2*a[3] - 2*z*a[3]) + y*z*((-4*a[3])/3 + (4*z*a[3])/3)) + x*(z*(2*a[5] - 2*z*a[5]) + y*y*(z*(2*a[7] - 2*z*a[7]) + y*z*((-4*a[7])/3 + (4*z*a[7])/3)) + x*(z*(-2*a[1] - 2*a[5] + z*(2*a[1] + 2*a[5])) + y*y*(y*z*((4*a[3])/3 + z*((-4*a[3])/3 - (4*a[7])/3) + (4*a[7])/3) + z*(-2*a[3] - 2*a[7] + z*(2*a[3] + 2*a[7]))))));
    poly[4] = 2*a[4] + z*z*(2*a[5] - (4*z*a[5])/3) + y*y*(2*a[6] + z*z*(2*a[7] - (4*z*a[7])/3) + y*((-4*a[6])/3 + z*z*((-4*a[7])/3 + (8*z*a[7])/9))) + x*(-6*a[0] - 6*a[4] + z*z*(-6*a[1] - 6*a[5] + z*(4*a[1] + 4*a[5])) + y*y*(-6*a[2] - 6*a[6] + z*z*(-6*a[3] - 6*a[7] + z*(4*a[3] + 4*a[7])) + y*(4*a[2] + 4*a[6] + z*z*(4*a[3] + z*((-8*a[3])/3 - (8*a[7])/3) + 4*a[7]))) - 6*c[0] + 6*c[1]);
    poly[5] = y*(2*a[2] + z*z*(2*a[3] - (4*z*a[3])/3) + y*(-2*a[2] + z*z*(-2*a[3] + (4*z*a[3])/3))) + x*(x*y*(-6*a[2] - 6*a[6] + z*z*(-6*a[3] - 6*a[7] + z*(4*a[3] + 4*a[7])) + y*(6*a[2] + 6*a[6] + z*z*(6*a[3] + z*(-4*a[3] - 4*a[7]) + 6*a[7]))) + y*(4*a[6] + z*z*(4*a[7] - (8*z*a[7])/3) + y*(-4*a[6] + z*z*(-4*a[7] + (8*z*a[7])/3))));
    poly[6] = z*(2*a[1] - 2*z*a[1]) + y*y*(z*(2*a[3] - 2*z*a[3]) + y*z*((-4*a[3])/3 + (4*z*a[3])/3)) + x*(z*(4*a[5] - 4*z*a[5]) + y*y*(z*(4*a[7] - 4*z*a[7]) + y*z*((-8*a[7])/3 + (8*z*a[7])/3)) + x*(z*(-6*a[1] - 6*a[5] + z*(6*a[1] + 6*a[5])) + y*y*(y*z*(4*a[3] + z*(-4*a[3] - 4*a[7]) + 4*a[7]) + z*(-6*a[3] - 6*a[7] + z*(6*a[3] + 6*a[7])))));
    poly[7] = x*(2*a[2] + z*z*(2*a[3] - (4*z*a[3])/3) + y*(-4*a[2] + z*z*(-4*a[3] + (8*z*a[3])/3)) + x*(2*a[6] + z*z*(2*a[7] - (4*z*a[7])/3) + y*(-4*a[6] + z*z*(-4*a[7] + (8*z*a[7])/3)) + x*(-2*a[2] - 2*a[6] + z*z*(-2*a[3] - 2*a[7] + z*((4*a[3])/3 + (4*a[7])/3)) + y*(4*a[2] + 4*a[6] + z*z*(4*a[3] + z*((-8*a[3])/3 - (8*a[7])/3) + 4*a[7])))));
    poly[8] = x*(y*(z*(4*a[3] - 4*z*a[3]) + y*z*(-4*a[3] + 4*z*a[3])) + x*(y*(z*(4*a[7] - 4*z*a[7]) + y*z*(-4*a[7] + 4*z*a[7])) + x*y*(y*z*(4*a[3] + z*(-4*a[3] - 4*a[7]) + 4*a[7]) + z*(-4*a[3] - 4*a[7] + z*(4*a[3] + 4*a[7])))));
    poly[9] = x*(2*a[1] - 4*z*a[1] + y*y*(2*a[3] - 4*z*a[3] + y*((-4*a[3])/3 + (8*z*a[3])/3)) + x*(2*a[5] - 4*z*a[5] + y*y*(2*a[7] - 4*z*a[7] + y*((-4*a[7])/3 + (8*z*a[7])/3)) + x*(-2*a[1] - 2*a[5] + z*(4*a[1] + 4*a[5]) + y*y*(-2*a[3] - 2*a[7] + y*((4*a[3])/3 + z*((-8*a[3])/3 - (8*a[7])/3) + (4*a[7])/3) + z*(4*a[3] + 4*a[7])))));
}


void ManufacturedSolution::cubic_none(valarray<double> &poly, const double x, const double y,
		const double z, const valarray<double> &c, const valarray<double> &a)
{
    #ifdef DBC
        size_t na=20;
    ...
    poly[0] = a[0] + z*(a[1] + z*(a[2] + z*a[3])) + y*(a[4] + z*(a[5] + z*a[6]) + y*(a[7] + z*a[8] + y*a[9])) + x*(a[10] + z*(a[11] + z*a[12]) + y*(a[13] + z*a[14] + y*a[15]) + x*(a[16] + z*a[17] + y*a[18] + x*a[19]));
    poly[1] = a[10] + z*(a[11] + z*a[12] + y*a[14] + 2*x*a[17]) + y*(a[13] + y*a[15] + 2*x*a[18]) + x*(2*a[16] + 3*x*a[19]);
    poly[2] = a[4] + z*(a[5] + z*a[6] + 2*y*a[8] + x*a[14]) + y*(2*a[7] + 3*y*a[9] + 2*x*a[15]) + x*(a[13] + x*a[18]);
    poly[3] = a[1] + z*(2*a[2] + 3*z*a[3] + 2*y*a[6] + 2*x*a[12]) + y*(a[5] + y*a[8] + x*a[14]) + x*(a[11] + x*a[17]);
    poly[4] = 2*a[16] + 2*z*a[17] + 2*y*a[18] + 6*x*a[19];
    poly[5] = a[13] + z*a[14] + 2*y*a[15] + 2*x*a[18];
    poly[6] = a[11] + 2*z*a[12] + y*a[14] + 2*x*a[17];
    poly[7] = 2*a[7] + 2*z*a[8] + 6*y*a[9] + 2*x*a[15];
    poly[8] = a[5] + 2*z*a[6] + 2*y*a[8] + x*a[14];
    poly[9] = 2*a[2] + 6*z*a[3] + 2*y*a[6] + 2*x*a[12];
}


void ManufacturedSolution::quad_cyl_rod_none(
		valarray<double> &poly,
		const double r, const double th, const double z,
		const valarray<double> &c, const valarray<double> &a)
{
    #ifdef DBC
        size_t na=15;
    ...
    poly[0] = a[0] + cth*a[0] + cth*cth*a[0] + sth*a[0] + cth*sth*a[0] + sth*sth*a[0] + z*(a[1] + cth*a[1] + sth*a[1] + z*a[2]) + r*(a[10] + cth*a[10] + sth*a[10] + z*a[11] + r*a[14]);
    poly[1] = a[10] + cth*a[10] + sth*a[10] + z*a[11] + 2*r*a[14];
    poly[2] = sth*(-a[0] - sth*a[0] - z*a[1]) + cth*(a[0] + cth*a[0] + z*a[1]) + r*(cth*a[10] - sth*a[10]);
    poly[3] = a[1] + cth*a[1] + sth*a[1] + 2*z*a[2] + r*a[11];
    poly[4] = 2*a[14];
    poly[5] = cth*a[10] - sth*a[10];
    poly[6] = a[11];
    poly[7] = cth*(-a[0] - z*a[1]) + sth*(-a[0] - 4*cth*a[0] - z*a[1]) + r*(-(cth*a[10]) - sth*a[10]);
    poly[8] = cth*a[1] - sth*a[1];
    poly[9] = 2*a[2];
}
		...
		const valarray<double> &c, const valarray<double> &a)
{
    ...
    poly[0] = a[0] + cth*(a[1] + cth*a[2]) + sth*(a[3] + cth*(a[4] + cth*a[5]) + sth*(a[6] + cth*(a[7] + cth*a[8]))) + r*(-2*c[0] - c[1] + r*(c[0] + c[1])) + z*(-c[2] + z*(c[2]/2 + c[3]/2));
    poly[1] = -2*c[0] - c[1] + r*(2*c[0] + 2*c[1]);
    poly[2] = cth*(a[3] + cth*(a[4] + cth*a[5])) + sth*(-a[1] + sth*(-a[4] - 2*cth*a[5] + sth*(-a[7] - 2*cth*a[8])) + cth*(-2*a[2] + 2*a[6] + cth*(2*a[7] + 2*cth*a[8])));
    poly[3] = -c[2] + z*(c[2] + c[3]);
    poly[4] = 2*c[0] + 2*c[1];
    poly[5] = 0;
    poly[6] = 0;
    poly[7] = cth*(-a[1] + cth*(-2*a[2] + 2*a[6] + cth*(2*a[7] + 2*cth*a[8]))) + sth*(-a[3] + cth*(-4*a[4] - 7*cth*a[5]) + sth*(2*a[2] - 2*a[6] + cth*(-7*a[7] - 12*cth*a[8]) + sth*(2*a[5] + 2*sth*a[8])));
    poly[8] = 0;
    poly[9] = c[2] + c[3];
}
		...
		const double th, const double z, const valarray<double> &c, const valarray<double> &a)
{
    ...
    double sth=sin(th), cth=cos(th);
    poly[0] = a[0] + cth*a[0] + cth*cth*a[0] + cth*cth*cth*a[0] + sth*a[0] + cth*sth*a[0] + cth*cth*sth*a[0] + sth*sth*a[0] + cth*sth*sth*a[0] + sth*sth*sth*a[0] + z*(a[1] + cth*a[1] + cth*cth*a[1] + sth*a[1] + cth*sth*a[1] + sth*sth*a[1] + z*(a[2] + cth*a[2] + sth*a[2] + z*a[3])) + r*(a[20] + cth*a[20] + cth*cth*a[20] + sth*a[20] + cth*sth*a[20] + sth*sth*a[20] + z*(a[21] + cth*a[21] + sth*a[21] + z*a[22]) + r*(a[30] + cth*a[30] + sth*a[30] + z*a[31] + r*a[34]));
    poly[1] = a[20] + cth*(a[20] + cth*a[20] + z*a[21]) + sth*(a[20] + cth*a[20] + sth*a[20] + z*a[21]) + z*(a[21] + z*a[22]) + r*(2*a[30] + 2*cth*a[30] + 2*sth*a[30] + 2*z*a[31] + 3*r*a[34]);
    poly[2] = sth*(-a[0] - cth*cth*a[0] + sth*(-a[0] + cth*a[0] - sth*a[0] - z*a[1]) + z*(-a[1] - z*a[2])) + cth*(a[0] + cth*(a[0] + cth*a[0] + z*a[1]) + z*(a[1] + z*a[2])) + r*(sth*(-a[20] - sth*a[20] - z*a[21]) + cth*(a[20] + cth*a[20] + z*a[21]) + r*(cth*a[30] - sth*a[30]));
    poly[3] = a[1] + cth*(a[1] + cth*a[1] + 2*z*a[2]) + sth*(a[1] + cth*a[1] + sth*a[1] + 2*z*a[2]) + z*(2*a[2] + 3*z*a[3]) + r*(a[21] + cth*a[21] + sth*a[21] + 2*z*a[22] + r*a[31]);
    poly[4] = 2*a[30] + 2*cth*a[30] + 2*sth*a[30] + 2*z*a[31] + 6*r*a[34];
    poly[5] = sth*(-a[20] - sth*a[20] - z*a[21]) + cth*(a[20] + cth*a[20] + z*a[21]) + r*(2*cth*a[30] - 2*sth*a[30]);
    poly[6] = a[21] + cth*a[21] + sth*a[21] + 2*z*a[22] + 2*r*a[31];
    poly[7] = cth*(-a[0] - cth*cth*a[0] + z*(-a[1] - z*a[2])) + sth*(-a[0] + sth*(-(cth*a[0]) - sth*a[0]) + cth*(-4*a[0] - cth*a[0] - 4*z*a[1]) + z*(-a[1] - z*a[2])) + r*(cth*(-a[20] - z*a[21]) + sth*(-a[20] - 4*cth*a[20] - z*a[21]) + r*(-(cth*a[30]) - sth*a[30]));
    poly[8] = sth*(-a[1] - sth*a[1] - 2*z*a[2]) + cth*(a[1] + cth*a[1] + 2*z*a[2]) + r*(cth*a[21] - sth*a[21]);
    poly[9] = 2*a[2] + 2*cth*a[2] + 2*sth*a[2] + 6*z*a[3] + 2*r*a[22];
}
...
void ManufacturedSolution::quad_cyl_shell_none(valarray<double> &poly, const double r,
		const double th, const double z, const valarray<double> &c, const valarray<double> &a)
{
}
		...
		const valarray<double> &c, const valarray<double> &a)
{
    ...
    const double sth=sin(th), cth=cos(th);
    poly[0] = a[0] + cth*(a[1] + cth*a[2]) + sth*(a[3] + cth*(cth*(-a[3] - a[4]) + a[4]) + sth*(a[5] + cth*(-a[1] - a[4] + cth*a[6]))) + r*(-2*c[0] - c[1] + r*(c[0] + c[1])) + z*(-c[2] + z*(c[2]/2 + c[3]/2));
    poly[1] = -2*c[0] - c[1] + r*(2*c[0] + 2*c[1]);
    poly[2] = cth*(a[3] + cth*(cth*(-a[3] - a[4]) + a[4])) + sth*(-a[1] + sth*(-a[4] + cth*(2*a[3] + 2*a[4]) + sth*(a[1] + a[4] - 2*cth*a[6])) + cth*(-2*a[2] + 2*a[5] + cth*(-2*a[1] - 2*a[4] + 2*cth*a[6])));
    poly[3] = -c[2] + z*(c[2] + c[3]);
    poly[4] = 2*c[0] + 2*c[1];
    poly[5] = 0;
    poly[6] = 0;
    poly[7] = cth*(-a[1] + cth*(-2*a[2] + 2*a[5] + cth*(-2*a[1] - 2*a[4] + 2*cth*a[6]))) + sth*(-a[3] + cth*(-4*a[4] + cth*(7*a[3] + 7*a[4])) + sth*(2*a[2] - 2*a[5] + cth*(7*a[1] + 7*a[4] - 12*cth*a[6]) + sth*(-2*a[3] - 2*a[4] + 2*sth*a[6])));
    poly[8] = 0;
    poly[9] = c[2] + c[3];
}
...
void ManufacturedSolution::quad_cyl_qtr_shell_none(valarray<double> &poly, const double r,
		const double th, const double z, const valarray<double> &c, const valarray<double> &a)
{
}
