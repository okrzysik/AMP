...
public:
    ...
    constexpr static uint16_t MAX_QUEUED = 1024; // The maximum number of items in the work queue at any moment
...
public:
     ...
     * @param ids               Array of work items to wait for
     */
    inline void wait_all( size_t N_work, const thread_id_t *ids ) const;
...
#include "AMP/utils/threadpool/thread_pool.hpp"
