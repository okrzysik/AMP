//
// File:	$URL:
// file:///usr/casc/samrai/repository/AMP/tags/v-2-4-4/source/toolbox/database/Database.C $
// Package:	AMP toolbox
...
void Database::putBoolArray( const std::string &key, const std::vector<unsigned char> &data )
{
    AMP_ASSERT( !key.empty() );
...
bool Database::getBoolWithDefault( const std::string &key, const bool &defaultvalue )
{
    AMP_ASSERT( !key.empty() );
    if ( keyExists( key ) ) {
...
void Database::getBoolArray( const std::string &key, bool *data, const int nelements )
{
    AMP_ASSERT( !key.empty() );
...
void Database::getScalar( const std::string &key, bool &scalar ) { scalar = getBool( key ); }

void Database::putScalar( const std::string &key, const bool scalar ) { putBool( key, scalar ); }
...
void Database::putDatabaseBox( const std::string &key, const DatabaseBox &data )
{
    AMP_ASSERT( !key.empty() );
...
void Database::putDatabaseBoxArray( const std::string &key, const std::vector<DatabaseBox> &data )
{
    AMP_ASSERT( !key.empty() );
    if ( static_cast<int>( data.size() ) > 0 ) {
...
DatabaseBox Database::getDatabaseBoxWithDefault( const std::string &key,
...
void Database::getDatabaseBoxArray( const std::string &key, DatabaseBox *data, const int nelements )
{
    AMP_ASSERT( !key.empty() );
...
void Database::putChar( const std::string &key, const char &data )
{
    AMP_ASSERT( !key.empty() );
...
void Database::putCharArray( const std::string &key, const std::vector<char> &data )
{
    AMP_ASSERT( !key.empty() );
    if ( static_cast<int>( data.size() ) > 0 ) {
...
char Database::getCharWithDefault( const std::string &key, const char &defaultvalue )
{
    AMP_ASSERT( !key.empty() );
    if ( keyExists( key ) ) {
...
void Database::getCharArray( const std::string &key, char *data, const int nelements )
{
    AMP_ASSERT( !key.empty() );
...
void Database::getScalar( const std::string &key, char &scalar ) { scalar = getChar( key ); }

void Database::putScalar( const std::string &key, const char scalar ) { putChar( key, scalar ); }
...
void Database::putComplex( const std::string &key, const std::complex<double> &data )
{
    AMP_ASSERT( !key.empty() );
...
void Database::putComplexArray( const std::string &key,
...
std::complex<double> Database::getComplexWithDefault( const std::string &key,
...
void Database::getComplexArray( const std::string &key,
...
void Database::putFloat( const std::string &key, const float &data )
{
    AMP_ASSERT( !key.empty() );
...
void Database::putFloatArray( const std::string &key, const std::vector<float> &data )
{
    AMP_ASSERT( !key.empty() );
    if ( static_cast<int>( data.size() ) > 0 ) {
...
float Database::getFloatWithDefault( const std::string &key, const float &defaultvalue )
{
    AMP_ASSERT( !key.empty() );
    if ( keyExists( key ) ) {
...
void Database::getFloatArray( const std::string &key, float *data, const int nelements )
{
    AMP_ASSERT( !key.empty() );
...
void Database::getScalar( const std::string &key, float &scalar ) { scalar = getFloat( key ); }

void Database::putScalar( const std::string &key, const float scalar ) { putFloat( key, scalar ); }
...
void Database::putDouble( const std::string &key, const double &data )
{
    AMP_ASSERT( !key.empty() );
...
void Database::putDoubleArray( const std::string &key, const std::vector<double> &data )
{
    AMP_ASSERT( !key.empty() );
    if ( static_cast<int>( data.size() ) > 0 ) {
...
double Database::getDoubleWithDefault( const std::string &key, const double &defaultvalue )
{
    AMP_ASSERT( !key.empty() );
    if ( keyExists( key ) ) {
...
void Database::getDoubleArray( const std::string &key, double *data, const int nelements )
{
    AMP_ASSERT( !key.empty() );
...
void Database::getScalar( const std::string &key, double &scalar ) { scalar = getDouble( key ); }
...
void Database::putInteger( const std::string &key, const int &data )
{
    AMP_ASSERT( !key.empty() );
...
void Database::putIntegerArray( const std::string &key, const std::vector<int> &data )
{
    AMP_ASSERT( !key.empty() );
    if ( static_cast<int>( data.size() ) > 0 ) {
...
int Database::getIntegerWithDefault( const std::string &key, const int &defaultvalue )
{
    AMP_ASSERT( !key.empty() );
    if ( keyExists( key ) ) {
...
void Database::getIntegerArray( const std::string &key, int *data, const int nelements )
{
    AMP_ASSERT( !key.empty() );
...
void Database::getScalar( const std::string &key, int &scalar ) { scalar = getInteger( key ); }

void Database::putScalar( const std::string &key, const int scalar ) { putInteger( key, scalar ); }
...
void Database::putString( const std::string &key, const std::string &data )
{
    AMP_ASSERT( !key.empty() );
...
void Database::putStringArray( const std::string &key, const std::vector<std::string> &data )
{
    AMP_ASSERT( !key.empty() );
    if ( static_cast<int>( data.size() ) > 0 ) {
...
std::string Database::getStringWithDefault( const std::string &key,
...
void Database::getStringArray( const std::string &key, std::string *data, const int nelements )
{
    AMP_ASSERT( !key.empty() );
