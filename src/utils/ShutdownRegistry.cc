//
// File:	$URL:
// file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-4-4/source/toolbox/base/ShutdownRegistry.C $
...
ShutdownRegistryItem *ShutdownRegistry::s_shutdown_list[s_number_of_priorities];
ShutdownRegistryItem *ShutdownRegistry::s_shutdown_list_last[s_number_of_priorities];
