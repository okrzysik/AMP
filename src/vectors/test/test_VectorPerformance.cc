...
struct test_times {
    ...
    void print_speedup( const test_times& time0 ) {
        ...
        AMP::pout<< "    setRandom: " << speedup( setRandomValues, time0.setRandomValues ) << std::endl;
...
#ifdef USE_OPENMP
    vec = AMP::LinearAlgebra::SimpleVector<double,AMP::LinearAlgebra::VectorOperationsOpenMP<double>>::create( N, var, globalComm );
...
#ifdef USE_CUDA
    vec = AMP::LinearAlgebra::SimpleVector<double,AMP::LinearAlgebra::VectorOperationsCuda<double>,
