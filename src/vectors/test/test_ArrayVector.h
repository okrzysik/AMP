...
template <typename T>
void
testArrayVectorDimensions( std::vector<size_t> &dims, AMP::UnitTest &ut)
{
    ...
    std::shared_ptr<AMP::LinearAlgebra::ArrayVector<T>> arrayVec = std::dynamic_pointer_cast<AMP::LinearAlgebra::ArrayVector<T>>(vec);
