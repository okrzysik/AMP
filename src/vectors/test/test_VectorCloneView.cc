...
typedef CloneFactory<
    ViewFactory<AMP::LinearAlgebra::PetscVector,
                SimpleManagedVectorFactory<AMP::LinearAlgebra::ManagedEpetraVector>>>
    SMEVFactory;
typedef CloneFactory<ViewFactory<AMP::LinearAlgebra::PetscVector,
...
typedef CloneFactory<ViewFactory<AMP::LinearAlgebra::PetscVector,
    ...
    MVFactory2;
typedef CloneFactory<
    ViewFactory<AMP::LinearAlgebra::PetscVector, MultiVectorFactory<MVFactory1, 2, MVFactory2, 2>>>
    MVFactory3;
#endif
