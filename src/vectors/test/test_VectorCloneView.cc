...
typedef AMP::LinearAlgebra::ArrayVectorFactory<4,10, true,double> ArrayFactory2;
    ...
    typedef AMP::LinearAlgebra::CloneFactory<AMP::LinearAlgebra::ViewFactory<AMP::LinearAlgebra::PetscVector,AMP::LinearAlgebra::SimpleManagedVectorFactory<AMP::LinearAlgebra::ManagedEpetraVector>>> SMEVFactory;
    typedef AMP::LinearAlgebra::CloneFactory<AMP::LinearAlgebra::ViewFactory<AMP::LinearAlgebra::PetscVector,AMP::LinearAlgebra::SimplePetscNativeFactory<AMP::LinearAlgebra::NativePetscVector>>>     SNPVFactory;
    typedef AMP::LinearAlgebra::CloneFactory<AMP::LinearAlgebra::ViewFactory<AMP::LinearAlgebra::PetscVector,AMP::LinearAlgebra::MultiVectorFactory<SMEVFactory,1,SNPVFactory,1>>> MVFactory1;
    typedef AMP::LinearAlgebra::CloneFactory<AMP::LinearAlgebra::ViewFactory<AMP::LinearAlgebra::PetscVector,AMP::LinearAlgebra::MultiVectorFactory<SMEVFactory,3,SNPVFactory,2>>> MVFactory2;
    typedef AMP::LinearAlgebra::CloneFactory<AMP::LinearAlgebra::ViewFactory<AMP::LinearAlgebra::PetscVector,AMP::LinearAlgebra::MultiVectorFactory<MVFactory1,2,MVFactory2,2>>>   MVFactory3;
#endif
// clang-format on
