...
const std::string ViewMVFactory1 = "ViewFactory<PetscVector,MultiVectorFactory<" + ViewSMEVFactory +
                                   ",1," + ViewSNPVFactory + ",1>>";
const std::string ViewMVFactory2 = "ViewFactory<PetscVector,MultiVectorFactory<" + ViewSMEVFactory +
                                   ",3," + ViewSNPVFactory + ",2>>";
const std::string ViewMVFactory3 = "ViewFactory<PetscVector,MultiVectorFactory<" + ViewMVFactory1 +
                                   ",2," + ViewMVFactory2 + ",2>>";
#endif
#if defined( USE_EXT_PETSC ) && defined( USE_EXT_TRILINOS )
const std::string CloneSMEVFactory =
    "CloneFactory<SimpleManagedVectorFactory<ManagedEpetraVector>>";
const std::string CloneSNPVFactory = "CloneFactory<SimplePetscNativeFactory>";
const std::string CloneMVFactory1 =
    "CloneFactory<MultiVectorFactory<" + CloneSMEVFactory + ",1," + CloneSNPVFactory + ",1>>";
const std::string CloneMVFactory2 =
    "CloneFactory<MultiVectorFactory<" + CloneSMEVFactory + ",3," + CloneSNPVFactory + ",2>>";
const std::string CloneMVFactory3 =
    "CloneFactory<MultiVectorFactory<" + CloneMVFactory1 + ",2," + CloneMVFactory2 + ",2>>";
#endif
#if defined( USE_EXT_PETSC ) && defined( USE_EXT_TRILINOS )
const std::string CloneViewSMEVFactory =
    "CloneFactory<ViewFactory<PetscVector,SimpleManagedVectorFactory<ManagedEpetraVector>>>";
const std::string CloneViewSNPVFactory =
    "CloneFactory<ViewFactory<PetscVector,SimplePetscNativeFactory>>";
const std::string CloneViewMVFactory1 = "CloneFactory<ViewFactory<PetscVector,MultiVectorFactory<" +
                                        CloneViewSMEVFactory + ",1," + CloneViewSNPVFactory +
                                        ",1>>>";
const std::string CloneViewMVFactory2 = "CloneFactory<ViewFactory<PetscVector,MultiVectorFactory<" +
                                        CloneViewSMEVFactory + ",3," + CloneViewSNPVFactory +
                                        ",2>>>";
const std::string CloneViewMVFactory3 = "CloneFactory<ViewFactory<PetscVector,MultiVectorFactory<" +
