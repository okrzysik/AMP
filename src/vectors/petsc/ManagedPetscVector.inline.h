...
inline ManagedVector *ManagedPetscVector::getNewRawPtr() const
{
    return new ManagedPetscVector( AMP::dynamic_pointer_cast<VectorParameters>( d_pParameters ) );
}

inline bool ManagedPetscVector::constructedWithPetscDuplicate()
{
    return d_bMadeWithPetscDuplicate;
}

inline ManagedPetscVector *ManagedPetscVector::rawClone() const
{
...
inline Vector::shared_ptr ManagedPetscVector::cloneVector( const Variable::shared_ptr p ) const
{
...
inline std::string ManagedPetscVector::type() const
{
