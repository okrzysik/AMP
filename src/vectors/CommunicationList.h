...
namespace LinearAlgebra {
  ...
  class CommunicationListParameters : public ParameterBase
  {
    public:
      /**
        * \brief Short hand name for the shared pointer for a communication list
        */
      typedef boost::shared_ptr<CommunicationListParameters>    shared_ptr;

      /**
        * \brief The communicator over which the communication list is computed
        */
      AMP_MPI                                                   d_comm;

      /**
        * \brief The number of local entities in the vector
        */
      size_t                                                    d_localsize;
  };
  ...
  class CommunicationList : public Castable
  {
    ...
    public:
      ...
      /**
        ...
        * \return A vector of indices not owned by the core but are stored
        * locally.
        */
      ...
      /**
        ...
        * \return A vector of indices owned by the core and shared on other
        * cores.
        */
      ...
      /**
        ...
        * \return The number of owned entries on this core shared with other
        * cores
        */
