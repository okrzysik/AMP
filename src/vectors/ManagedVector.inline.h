...
inline VectorEngine::shared_ptr  ManagedVector::getVectorEngine()
{
    return d_Engine;
}
inline VectorEngine::const_shared_ptr  ManagedVector::getVectorEngine() const
{
    return d_Engine;
}
...
inline size_t  ManagedVector::numberOfDataBlocks () const
{
...
inline bool ManagedVector::isAnAliasOf ( Vector::shared_ptr rhs )
{
...
inline size_t ManagedVector::getLocalSize() const
{
    return d_Engine->getLocalSize();
}


inline size_t ManagedVector::getGlobalSize() const
{
    return d_Engine->getGlobalSize();
}


inline void ManagedVector::setToScalar(double alpha)
{
...
inline double ManagedVector::L1Norm(void) const
{
    return d_Engine->L1Norm ();
}


inline double ManagedVector::L2Norm(void) const
{
    return d_Engine->L2Norm ();
}


inline double ManagedVector::maxNorm(void) const
{
...
inline void ManagedVector::scale(double alpha, const VectorOperations &x)
{
    if ( x.isA<ManagedVector> () )
    {
...
inline void ManagedVector::scale(double alpha)
{
...
inline void ManagedVector::add(const VectorOperations &x, const VectorOperations &y)
{
...
inline void ManagedVector::subtract(const VectorOperations &x, const VectorOperations &y)
{
    if ( x.isA<ManagedVector> () && y.isA<ManagedVector>() )
    {
...
inline void ManagedVector::multiply(const VectorOperations &x, const VectorOperations &y)
{
    if ( x.isA<ManagedVector> () && y.isA<ManagedVector>() )
    {
...
inline void ManagedVector::divide(const VectorOperations &x, const VectorOperations &y)
{
    if ( x.isA<ManagedVector> () && y.isA<ManagedVector>() )
    {
...
inline void ManagedVector::reciprocal(const VectorOperations &x)
{
...
inline void ManagedVector::linearSum(double alpha, const VectorOperations &x,
...
inline void ManagedVector::axpy(double alpha, const VectorOperations &x, const VectorOperations &y)
{
    if ( x.isA<ManagedVector> () && y.isA<ManagedVector>() )
    {
...
inline void ManagedVector::axpby(double alpha, double beta, const VectorOperations &x)
{
    if ( x.isA<ManagedVector> () )
    {
...
inline void ManagedVector::abs(const VectorOperations &x)
{
    if ( x.isA<ManagedVector> () )
    {
...
inline double ManagedVector::min(void) const
{
    return d_Engine->min ();
}


inline double ManagedVector::max(void) const
{
    return d_Engine->max ();
}


inline void ManagedVector::setRandomValues(void)
{
