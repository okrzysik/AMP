...
inline double ManagedVector::L1Norm( void ) const { return d_Engine->L1Norm(); }


inline double ManagedVector::L2Norm( void ) const { return d_Engine->L2Norm(); }


inline double ManagedVector::maxNorm( void ) const { return d_Engine->maxNorm(); }
...
inline void ManagedVector::linearSum( double alpha,
...
inline double ManagedVector::min( void ) const { return d_Engine->min(); }


inline double ManagedVector::max( void ) const { return d_Engine->max(); }
