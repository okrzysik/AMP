...
void CudaOperationsHelpers<TYPE>::setToScalar( TYPE alpha, size_t N, TYPE *x )
{
    thrust::fill_n( thrust::device, x, N, alpha );
}

template<typename TYPE>
void CudaOperationsHelpers<TYPE>::copy( size_t N, const TYPE *x, TYPE *y )
{
    thrust::copy_n( thrust::device, x, N, y );
}

template<typename TYPE>
void CudaOperationsHelpers<TYPE>::scale( TYPE alpha, size_t N, TYPE *x )
{
...
template<typename TYPE>
void CudaOperationsHelpers<TYPE>::scale( TYPE alpha, size_t N, const TYPE *x, TYPE *y )
{
...
template<typename TYPE>
void CudaOperationsHelpers<TYPE>::add( size_t N, const TYPE *x, const TYPE *y, TYPE *z )
{
    thrust::transform( thrust::device, x, x + N, y, z, thrust::plus<TYPE>() );
}

template<typename TYPE>
void CudaOperationsHelpers<TYPE>::subtract( size_t N, const TYPE *x, const TYPE *y, TYPE *z )
{
    thrust::transform( thrust::device, x, x + N, y, z, thrust::minus<TYPE>() );
}

template<typename TYPE>
void CudaOperationsHelpers<TYPE>::multiply( size_t N, const TYPE *x, const TYPE *y, TYPE *z )
{
    thrust::transform( thrust::device, x, x + N, y, z, thrust::multiplies<TYPE>() );
}

template<typename TYPE>
void CudaOperationsHelpers<TYPE>::divide( size_t N, const TYPE *x, const TYPE *y, TYPE *z )
{
...
template<typename TYPE>
void CudaOperationsHelpers<TYPE>::reciprocal( size_t N, const TYPE *x, TYPE *y )
{
...
template<typename TYPE>
void CudaOperationsHelpers<TYPE>::linearSum(
...
template<typename TYPE>
void CudaOperationsHelpers<TYPE>::abs( size_t N, const TYPE *x, TYPE *y )
{
...
template<typename TYPE>
void CudaOperationsHelpers<TYPE>::addScalar( size_t N, const TYPE *x, TYPE alpha, TYPE *y )
{
    auto lambda = [alpha] __device__( TYPE x ) { return x + alpha; };
    thrust::transform( thrust::device, x, x + N, y, lambda );
}
...
template<typename TYPE>
TYPE CudaOperationsHelpers<TYPE>::localMin( size_t N, const TYPE *x )
{
...
template<typename TYPE>
TYPE CudaOperationsHelpers<TYPE>::localL1Norm( size_t N, const TYPE *x )
{
    auto lambda = [=] __device__( TYPE x ) { return x < 0 ? -x : x; };
...
template<typename TYPE>
TYPE CudaOperationsHelpers<TYPE>::localL2Norm( size_t N, const TYPE *x )
{
...
template<typename TYPE>
TYPE CudaOperationsHelpers<TYPE>::localMaxNorm( size_t N, const TYPE *x )
{
    auto lambda = [=] __device__( TYPE x ) { return x < 0 ? -x : x; };
    return thrust::transform_reduce(
...
template<typename TYPE>
TYPE CudaOperationsHelpers<TYPE>::localDot( size_t N, const TYPE *x, const TYPE *y )
{
    return thrust::inner_product( thrust::device, x, x + N, y, (TYPE) 0 );
}

template<typename TYPE>
TYPE CudaOperationsHelpers<TYPE>::localMinQuotient( size_t N, const TYPE *x, const TYPE *y )
{
...
template<typename TYPE>
TYPE CudaOperationsHelpers<TYPE>::localWrmsNorm( size_t N, const TYPE *x, const TYPE *y )
{
