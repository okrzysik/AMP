...
inline bool VectorOperations::equals( std::shared_ptr<const VectorData> x,
...
inline void VectorOperations::zero( std::shared_ptr<VectorData> x ) { zero( *x ); }
...
inline void VectorOperations::copy( std::shared_ptr<const VectorData> x,
                                    std::shared_ptr<VectorData> y )
{
    copy( *x, *y );
}
...
inline void VectorOperations::scale( double alpha,
...
void VectorOperations::addScalar( std::shared_ptr<const VectorData> x,
                                  double alpha,
                                  std::shared_ptr<VectorData> y )
{
    addScalar( *x, alpha, *y );
...
inline void VectorOperations::reciprocal( std::shared_ptr<const VectorData> x,
                                          std::shared_ptr<VectorData> y )
{
    reciprocal( *x, *y );
}
...
inline void VectorOperations::axpby( double alpha,
                                     double beta,
                                     std::shared_ptr<const VectorData> x,
                                     std::shared_ptr<VectorData> y )
{
...
inline void VectorOperations::abs( std::shared_ptr<const VectorData> x,
                                   std::shared_ptr<VectorData> y )
{
    return abs( *x, *y );
}
inline double VectorOperations::dot( std::shared_ptr<const VectorData> x,
