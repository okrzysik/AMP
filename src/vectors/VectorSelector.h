...
namespace LinearAlgebra {
  ...
  /** \brief A class used by Vector::select and Vector::selectInto to create
    ...
    * be considered for fine selection.  The getSubsetter method return a class
    * that can be used to create a fine subset of the Vector.  These methods are
  ...
  class VectorSelector 
  {
    public:
      ...
      /** \brief Returns a VectorSubsetter that is used to perform fine-grain selection
        * of data in Vectors
        * \details Base class defaults to selecting all data in a vector.
        */
      virtual  VectorSubsetter::shared_ptr  getSubsetter () const;
  };
...
#include "VectorSelector.inline.h"
