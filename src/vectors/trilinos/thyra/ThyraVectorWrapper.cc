...
template <class TYPE>
static std::vector<const ThyraVectorWrapper *> getConstPtr(
    std::vector<size_t> block_size, Teuchos::ArrayView<const Teuchos::Ptr<const TYPE>> vecs );
