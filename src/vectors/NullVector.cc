...
void NullVector::linearSum( double, const VectorOperations &, double, const VectorOperations & ) {}
...
double NullVector::min( void ) const { return 0.0; }


double NullVector::max( void ) const { return 0.0; }
...
double NullVector::L1Norm( void ) const { return 0.0; }


double NullVector::L2Norm( void ) const { return 0.0; }


double NullVector::maxNorm( void ) const { return 0.0; }


double NullVector::dot( const VectorOperations & ) const { return 0.0; }
