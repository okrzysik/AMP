...
namespace LinearAlgebra {
  ...
  inline
  void  NativePetscMatrix::addValuesByGlobalID ( int num_rows , int num_cols , int *rows, int *cols, double *values )
  {
    MatSetValues ( d_Mat , num_rows , rows , num_cols , cols , values , ADD_VALUES );
  }

  inline
  void  NativePetscMatrix::setValuesByGlobalID ( int num_rows , int num_cols , int *rows, int *cols, double *values )
  {
    MatSetValues ( d_Mat , num_rows , rows , num_cols , cols , values , INSERT_VALUES );
  }

  inline
  void  NativePetscMatrix::scale ( double alpha )
  {
  ...
  inline
  void NativePetscMatrix::setDiagonal ( const Vector::shared_ptr &in )
  {
