...
void GetRowHelperLean::NNZ( BIGINT_TYPE row, INT_TYPE &num_local, INT_TYPE &num_remote )
{
    PROFILE( "GetRowHelperLean::NNZ" );
...
void GetRowHelperLean::getRow( BIGINT_TYPE row, BIGINT_TYPE *cols_local, BIGINT_TYPE *cols_remote )
{
    PROFILE( "GetRowHelperLean::getRow" );
