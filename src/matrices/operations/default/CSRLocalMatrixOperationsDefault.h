...
class CSRLocalMatrixOperationsDefault
{
     ...
     */
    void scale( AMP::Scalar alpha, std::shared_ptr<LocalMatrixData> A ) override;
     ...
     */
    void
    matMultiply( std::shared_ptr<LocalMatrixData> A, MatrixData const &B, MatrixData &C ) override;
    ...
    void axpy( AMP::Scalar alpha,
               ...
               std::shared_ptr<LocalMatrixData> Y ) override;
     ...
     */
    void setScalar( AMP::Scalar alpha, std::shared_ptr<LocalMatrixData> A ) override;

    /** \brief  Set the non-zeros of the matrix to zero
     * \details  May not deallocate space.
     * \param[in] A The input matrix A
     */
    void zero( std::shared_ptr<LocalMatrixData> A ) override;
    ...
    void setDiagonal( std::shared_ptr<const Vector> in,
                      std::shared_ptr<LocalMatrixData> A ) override;

    /** \brief Extract the diagonal values into a vector
     * \param[in] in The values to set the diagonal to
     * \param[in] A The matrix to set
     */
    void extractDiagonal( std::shared_ptr<LocalMatrixData> A,
                          std::shared_ptr<Vector> buf ) override;

    /** \brief  Set the matrix to the identity matrix
     * \param[out] A The matrix to set
     */
    void setIdentity( std::shared_ptr<LocalMatrixData> A ) override;

    /** \brief Compute the maximum row sum
     * \return  The L-infinity norm of the matrix
     * \param[in] A Data for the input matrix
     */
    void LinfNorm( std::shared_ptr<LocalMatrixData> A ) const override;
};
