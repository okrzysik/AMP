    ...
    AMP::LinearAlgebra::Vector::shared_ptr resultVec )
{
    ...
    // Create the matrix
        ...
        AMP::shared_ptr<AMP::LinearAlgebra::ManagedPetscMatrix>  newMatrix( new AMP::LinearAlgebra::ManagedPetscMatrix(params) );
    #else
        AMP::shared_ptr<AMP::LinearAlgebra::ManagedEpetraMatrix>  newMatrix( new AMP::LinearAlgebra::ManagedEpetraMatrix(params) );
    #endif
