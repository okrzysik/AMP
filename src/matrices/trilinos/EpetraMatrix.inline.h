...
namespace LinearAlgebra {
  ...
  inline
  Epetra_CrsMatrix        &EpetraMatrix::getEpetra_CrsMatrix()         
  { 
    return *d_epetraMatrix; 
  }

  inline
  const Epetra_CrsMatrix  &EpetraMatrix::getEpetra_CrsMatrix() const   
  { 
    return *d_epetraMatrix; 
  }
