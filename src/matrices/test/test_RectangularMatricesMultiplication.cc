...
void myTest(AMP::UnitTest *ut, std::string exeName) {
  ...
  AMP::LinearAlgebra::Matrix::shared_ptr firstMat = AMP::LinearAlgebra::createMatrix(firstVec, secondVec); // mxn
  AMP::LinearAlgebra::Matrix::shared_ptr secondMat = AMP::LinearAlgebra::createMatrix(secondVec, firstVec); // nxm
  AMP::LinearAlgebra::Matrix::shared_ptr thirdMat = AMP::LinearAlgebra::createMatrix(firstVec, firstVec); // nxn
  AMP::LinearAlgebra::Matrix::shared_ptr fourthMat = AMP::LinearAlgebra::createMatrix(secondVec, secondVec); // mxm
  firstMat->setScalar(1.0);
  secondMat->setScalar(2.0);
  // do matrix multiplications
  std::cout<<"I was here"<<std::endl;
  thirdMat = AMP::LinearAlgebra::Matrix::matMultiply(secondMat, firstMat);
  std::cout<<"Dead"<<std::endl;
  fourthMat = AMP::LinearAlgebra::Matrix::matMultiply(firstMat, secondMat);
  ut->passes(exeName);
}
