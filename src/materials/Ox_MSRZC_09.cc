...
Journal of Nuclear Materials 394 (2009) 182--189");
	...
	static const double SCparams[7]={-9.386, -4.26e3, 1.2e-3, 7.5e-4,
...
//=================== Classes =======================================================
	...
	public:
		FickCoefficientProp() :
			Property<double> (	
								name_base + "_" + "FickCoefficient",		// Name string
	...
	public:
		SoretCoefficientProp() :
			Property<double> (	
								name_base + "_" + "SoretCoefficient",		// Name string
								source,										// Reference source
...
//=================== Thermal Diffusion Interface ================================
	...
	static double thermalDiffusionParams[numberThDiffParams] =
		{-9.386, -4.26e3, 1.2e-3, 7.5e-4, -9.386, -4.26e3, 1.2e-3, 7.5e-4,
		 -1380.8, -134435.5, 0.0261};
