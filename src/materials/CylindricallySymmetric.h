...
namespace AMP {
namespace Materials {
    class CylindricallySymmetric : public AMP::Materials::Material { public:
...
static struct CylindricallySymmetric_INIT {
    CylindricallySymmetric_INIT() {
        static AMP::voodoo::Registration<AMP::Materials::Material,AMP::Materials::CylindricallySymmetric> reg("CylindricallySymmetric");
     }
} CylindricallySymmetric_init;
