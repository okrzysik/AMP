...
S(r) = - D(r) (u''(r) + u'(r)/r - gamma [u'(r)]^2) ");
	...
	static const double TmaxVal=1E6;				// DEBUG: This value was not provided, but is needed for ranges - set arbitrarily high
	static const double uminVal=0.0;
	static const double umaxVal=1E6;				// DEBUG: This value was not provided, but is needed for ranges - set arbitrarily high
