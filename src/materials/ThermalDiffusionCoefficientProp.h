 ...
 * They depend on previous definitions of Fick and Soret coefficients and optionally their derivatives.
 ...
 * Specializations may be handled within specific material header files in lieu of including this one.
 */
...
public:
	ThermalDiffusionCoefficientProp() :
		AMP::Materials::Property<double> (	
							...
							numberThermDiffArgs, thermDiffRanges ), d_ExtraParams(2){}								// Number of arguments
...
public:
	DxThermalDiffusionCoefficientProp() :
		AMP::Materials::Property<double> (	
							...
							numberThDiffParams,												// Number of parameters
							thermDiffArgs,														// Names of arguments to the eval function
							numberThermDiffArgs, thermDiffRanges ), d_ExtraParams(4){}								// Number of arguments
