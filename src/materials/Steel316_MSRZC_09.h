...
namespace AMP {
namespace Materials {
    class Steel316_MSRZC_09 : public Material { public:
    	Steel316_MSRZC_09();
    };
}
}
...
static struct Steel316_MSRZC_09 {
    Steel316_MSRZC_09() {
        static AMP::voodoo::Registration<AMP::Materials::Material,AMP::Materials::Steel316_MSRZC_09> reg("Steel316_MSRZC_09");
     }
