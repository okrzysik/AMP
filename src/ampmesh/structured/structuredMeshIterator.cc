...
********************************************************/
MeshIterator* structuredMeshIterator::clone() const
{
    return new structuredMeshIterator(*this);
}
...
********************************************************/
size_t structuredMeshIterator::size() const
{
    return d_elements->size();
}
size_t structuredMeshIterator::position() const
{
    return d_pos;
}
...
bool structuredMeshIterator::operator==(const MeshIterator& rhs) const
{
    ...
    structuredMeshIterator* tmp = (structuredMeshIterator*) &rhs;     // Convert rhs to a structuredMeshIterator* so we can access the base class members
    ...
    } else if ( ((structuredMeshIterator*)tmp->iterator)->typeID==structuredMeshIteratorTypeID ) {
