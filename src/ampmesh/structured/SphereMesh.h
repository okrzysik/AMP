#ifndef included_AMP_SphereBoxMesh
#define included_AMP_SphereBoxMesh
...
/**
 * \class SphereMesh
 * \brief A derived version of BoxMesh for a shpere
 * \details A concrete implementation of BoxMesh for a shpere
 */
class SphereMesh : public AMP::Mesh::StructuredGeometryMesh
{
public:
    //! Default constructor
...
private:
    SphereMesh(); // Private empty constructor
};
