...
void myTest(AMP::UnitTest *ut, std::string exeName) {
   ...
   boost::shared_ptr<AMP::Mesh::initializeLibMesh> libmeshInit(new AMP::Mesh::initializeLibMesh(globalComm));
   {
      ...
      boost::shared_ptr<AMP::Database> dirichletVectorCorrectionDatabase = input_db->getDatabase(dirichletVectorCorrectionDatabaseName);
      ...
      boost::shared_ptr<AMP::LinearAlgebra::MultiVariable>  multivariable = 
         boost::dynamic_pointer_cast<AMP::LinearAlgebra::MultiVariable>(mechanicsNonlinearVolumeOperator->getInputVariable() );
