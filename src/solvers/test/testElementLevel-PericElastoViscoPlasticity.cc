...
void myTest( AMP::UnitTest *ut, std::string exeName )
{
        ...
        new AMP::Mesh::initializeLibMesh( globalComm ) );
    {
        ...
        AMP::shared_ptr<AMP::Operator::MechanicsNonlinearFEOperator>
            nonlinearMechanicsVolumeOperator =
        ...
        AMP::shared_ptr<AMP::Operator::MechanicsNonlinearFEOperator>
            mechanicsNonlinearVolumeOperator =
                AMP::dynamic_pointer_cast<AMP::Operator::MechanicsNonlinearFEOperator>(
                    nonlinearMechanicsBVPoperator->getVolumeOperator() );
        ...
        */
        ...
        AMP::shared_ptr<AMP::Database> pcSolver_db =
        ...
        for ( int step = 0; step < NumberOfLoadingSteps; step++ ) {
            ...
            dirichletVectorCorrectionDatabase->putDouble( "value_6_0",
