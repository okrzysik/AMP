...
void myTest( AMP::UnitTest *ut, std::string exeName )
{
    ...
    AMP::pout << "RHS L2 norm before corrections = " << std::setprecision( 10 )
              << ( rhsVec->L2Norm() ) << "\n";
    ...
    AMP::pout << "RHS L2 norm after corrections = " << std::setprecision( 10 )
              << ( rhsVec->L2Norm() ) << "\n";
    ...
    AMP::pout << " Solution L1 Norm: " << std::setprecision( 10 ) << ( solVec->L1Norm() )
              << std::endl;
    AMP::pout << " Solution L2 Norm: " << std::setprecision( 10 ) << ( solVec->L2Norm() )
              << std::endl;
    ...
    AMP::pout << "Final Residual Norm: " << std::setprecision( 10 ) << finalResidualNorm
              << std::endl;
    AMP::pout << "Final Solution Norm: " << std::setprecision( 10 ) << finalSolutionNorm
              << std::endl;
