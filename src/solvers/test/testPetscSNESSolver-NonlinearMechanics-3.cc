...
void myTest(AMP::UnitTest *ut, std::string exeName)
{
  ...
  if(exeName == "testPetscSNESSolver-NonlinearMechanics-Cylinder") {
    meshAdapter = manager->getMesh ( "cylinder" );
  } else {
    if(exeName == "testPetscSNESSolver-NonlinearMechanics-HaldenPellet") {
  ...
  AMP::LinearAlgebra::Vector::shared_ptr mechNlPressureVec = meshAdapter->createVector( residualVariable );
