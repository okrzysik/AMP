...
std::map<std::string, std::tuple<int, double, double>> conv_map{
    ...
    { "input_testLinearSolvers-LinearThermalRobin-AMPMesh-CG",
      std::make_tuple( 75, 3.72098540086143e-10, 4.0e-10 ) },
    ...
    { "input_testLinearSolvers-LinearThermalRobin-TFQMR",
      std::make_tuple( 20, 6.93865e-10, 4.0e-10 ) },
    ...
    { "input_testLinearSolvers-LinearThermalRobin-AMPMesh-BoomerAMG",
      std::make_tuple( 23, 5.74719099691537e-13, 6.0e-13 ) },
    { "input_testLinearSolvers-LinearThermalRobin-AMPMesh-BoomerAMG-CG",
      std::make_tuple( 11, 3.49855872978825e-10, 4.0e-10 ) },
    ...
    { "input_testLinearSolvers-LinearThermalRobin-BoomerAMG-TFQMR",
      std::make_tuple( 5, 7.99889021918635e-10, 8.0e-10 ) },
