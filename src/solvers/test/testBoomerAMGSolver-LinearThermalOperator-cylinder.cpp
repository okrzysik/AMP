...
void linearThermalTest( AMP::UnitTest *ut )
{
    ...
    std::string exeName( "testBoomerAMGSolver-LinearThermalOperator-cylinder" );
    ...
    /*
      ...
      std::shared_ptr<AMP::Solver::BoomerAMGSolver>         mlSolver(new
      AMP::Solver::BoomerAMGSolver(mlSolverParams));
