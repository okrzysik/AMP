...
void linearThermalTest( AMP::UnitTest *ut )
{
    ...
    /*
      ...
      std::shared_ptr<AMP::Solver::TrilinosMueLuSolver>         mlSolver(new
    ...
    */
    ...
    std::shared_ptr<AMP::Solver::TrilinosMueLuSolverParameters> pcSolverParams(
        new AMP::Solver::TrilinosMueLuSolverParameters( pcSolver_db ) );
    pcSolverParams->d_pOperator = diffusionOperator;
    std::shared_ptr<AMP::Solver::TrilinosMueLuSolver> pcSolver(
