...
public:
   ...
   virtual void initialize(boost::shared_ptr<SolverStrategyParameters> const parameters);
     ...
     *                           values resulting in increasingly verbose information being printed out.
     */
     ...
     * @param[in] use_zero_guess    boolean to specify whether zero initial guess should be used or not.
     */
