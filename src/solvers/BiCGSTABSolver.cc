...
BiCGSTABSolver::BiCGSTABSolver(AMP::shared_ptr<KrylovSolverParameters> parameters):SolverStrategy(parameters), d_restarts(0)
{
...
****************************************************************/
void
BiCGSTABSolver::initialize(AMP::shared_ptr<SolverStrategyParameters> const params)
{
...
****************************************************************/
void
BiCGSTABSolver::solve(AMP::shared_ptr<const AMP::LinearAlgebra::Vector>  f,
		      AMP::shared_ptr<AMP::LinearAlgebra::Vector>  u)
{
  ...
  if(d_iDebugPrintInfoLevel>1) {
    std::cout << "BiCGSTABSolver::solve: initial L2Norm of solution vector: " << u->L2Norm() << std::endl;
...
void BiCGSTABSolver::resetOperator(const AMP::shared_ptr<AMP::Operator::OperatorParameters> params)
{
  if(d_pOperator.get()!=NULL) {
