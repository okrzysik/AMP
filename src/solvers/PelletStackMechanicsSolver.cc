...
PelletStackMechanicsSolver :: PelletStackMechanicsSolver(AMP::shared_ptr<
...
void PelletStackMechanicsSolver :: resetOperator(const AMP::shared_ptr<AMP::Operator::OperatorParameters> params) 
{
