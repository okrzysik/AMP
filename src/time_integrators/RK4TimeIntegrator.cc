...
void
RK4TimeIntegrator::setupVectors( void )
{
...
*/
bool
RK4TimeIntegrator::checkNewSolution( void ) const
{
   /*
...
*/
void
RK4TimeIntegrator::updateSolution( void )
{
...
double 
RK4TimeIntegrator::getNextDt(const bool )
{
  return d_current_dt;
}
