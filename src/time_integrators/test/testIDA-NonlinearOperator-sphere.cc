...
#include "AMP/matrices/ManagedEpetraMatrix.h"
#include "AMP/operators/NeutronicsRhs.h"
...
void IDATimeIntegratorTest( AMP::UnitTest *ut )
{
    ...
    linearOperator = AMP::dynamic_pointer_cast<AMP::Operator::LinearBVPOperator>(
    ...
    AMP::shared_ptr<AMP::Operator::DiffusionNonlinearFEOperator> thermalVolumeOperator =
        AMP::dynamic_pointer_cast<AMP::Operator::DiffusionNonlinearFEOperator>(
            nonlinearOperator->getVolumeOperator() );
    ...
    AMP::shared_ptr<AMP::ManagedEpetraMatrix> massMatrix =
        AMP::dynamic_pointer_cast<AMP::ManagedEpetraMatrix>( massOperator->getMatrix() );
