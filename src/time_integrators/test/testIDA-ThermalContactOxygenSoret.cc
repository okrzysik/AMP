...
void thermalContactTest( AMP::UnitTest *ut, const std::string &exeName )
{
    ...
    AMP::LinearAlgebra::Variable::shared_ptr inputVariable1(
        new AMP::NodalScalarVariable( "Temperature", meshAdapter1 ) );
    AMP::LinearAlgebra::Variable::shared_ptr inputVariable2(
        new AMP::NodalScalarVariable( "Temperature", meshAdapter2 ) );
    AMP::LinearAlgebra::Variable::shared_ptr oxygenInputVariable(
        new AMP::NodalScalarVariable( "Concentration", meshAdapter1 ) );
    ...
    AMP::LinearAlgebra::Variable::shared_ptr outputVariable2(
        new AMP::NodalScalarVariable( "Temperature", meshAdapter2 ) );
    AMP::LinearAlgebra::Variable::shared_ptr oxygenOutputVariable(
        new AMP::NodalScalarVariable( "Concentration", meshAdapter1 ) );
  ...
  AMP::LinearAlgebra::Vector::shared_ptr oxygenICPrime = manager->createVector ( oxygenInputVariable );
    ...
    AMP::LinearAlgebra::Vector::shared_ptr RightHandSideVec =
        manager->createVector( outputVariable );
    ...
    AMP::LinearAlgebra::Vector::shared_ptr temperature =
        solutionVector->subsetVectorForVariable( temperatureVariable );
    AMP::LinearAlgebra::Vector::shared_ptr oxygen =
        solutionVector->subsetVectorForVariable( oxygenInputVariable );

    AMP::LinearAlgebra::Vector::shared_ptr temperatureICPrime =
        solutionPrime->subsetVectorForVariable( temperatureVariable );
    AMP::LinearAlgebra::Vector::shared_ptr oxygenICPrime =
        solutionPrime->subsetVectorForVariable( oxygenInputVariable );

    AMP::LinearAlgebra::Vector::shared_ptr temperatureRhs =
        RightHandSideVec->subsetVectorForVariable( temperatureVariable );
    AMP::LinearAlgebra::Vector::shared_ptr oxygenRhs =
        RightHandSideVec->subsetVectorForVariable( oxygenOutputVariable );

    AMP::LinearAlgebra::Vector::shared_ptr temperatureScratch =
        scratchVec->subsetVectorForVariable( temperatureVariable );
#endif

    AMP::LinearAlgebra::Vector::shared_ptr temperatureVec1 =
        temperature->subsetVectorForVariable( inputVariable1 );
    AMP::LinearAlgebra::Vector::shared_ptr temperatureVec2 =
        temperature->subsetVectorForVariable( inputVariable2 );
    AMP::LinearAlgebra::Vector::shared_ptr temperatureICPrime1 =
        temperatureICPrime->subsetVectorForVariable( inputVariable1 );
    AMP::LinearAlgebra::Vector::shared_ptr temperatureRHS1 =
        temperatureRhs->subsetVectorForVariable( outputVariable1 );
    AMP::LinearAlgebra::Vector::shared_ptr temperatureRHS2 =
        temperatureRhs->subsetVectorForVariable( outputVariable2 );
    ...
    AMP::LinearAlgebra::Vector::shared_ptr temperatureScratch1 =
        temperatureScratch->subsetVectorForVariable( outputVariable1 );
    AMP::LinearAlgebra::Vector::shared_ptr RightHandSideVec2 =
        RightHandSideVec->subsetVectorForVariable( outputVariable2 );

    double temperatureInitialGuess =
        input_db->getDoubleWithDefault( "TemperatureInitialGuess", 400 );
    ...
    AMP::pout << "L2 Norm of the PowerInWattsVec and temperatureRHS1 " << PowerInWattsVec->L2Norm()
              << " " << temperatureRHS1->L2Norm() << std::endl;
    ...
    AMP::shared_ptr<AMP::Operator::LinearBVPOperator> linearThermalOperator1 =
        AMP::dynamic_pointer_cast<AMP::Operator::LinearBVPOperator>(
            AMP::Operator::OperatorBuilder::createOperator(
                meshAdapter1, bvpDatabase1, thermalTransportModel1 ) );
    ...
    AMP::shared_ptr<AMP::Operator::LinearBVPOperator> linearThermalOperator2 =
        AMP::dynamic_pointer_cast<AMP::Operator::LinearBVPOperator>(
            AMP::Operator::OperatorBuilder::createOperator(
                meshAdapter2, bvpDatabase2, thermalTransportModel2 ) );
    ...
    AMP::Operator::Operator::shared_ptr robinBoundaryOp1 =
        nonlinearThermalOperator1->getBoundaryOperator();
    ...
    AMP::shared_ptr<AMP::Database> nonlinearOxygenDatabase =
        input_db->getDatabase( "NonlinearOxygenOperator" );
    AMP::shared_ptr<AMP::Operator::NonlinearBVPOperator> nonlinearOxygenOperator =
        AMP::dynamic_pointer_cast<AMP::Operator::NonlinearBVPOperator>(
            AMP::Operator::OperatorBuilder::createOperator(
                meshAdapter1, nonlinearOxygenDatabase, oxygenModel ) );
    // ---------------------------------------------------------------------------------------
    ...
    AMP::shared_ptr<AMP::InputDatabase> linearOxygenOp_db =
        AMP::dynamic_pointer_cast<AMP::InputDatabase>(
            input_db->getDatabase( "LinearOxygenOperator" ) );
    linearOxygenOperator = AMP::dynamic_pointer_cast<AMP::Operator::LinearBVPOperator>(
        AMP::Operator::OperatorBuilder::createOperator(
            meshAdapter1, linearOxygenOp_db, oxygenModel ) );
    ...
    AMP::shared_ptr<AMP::Operator::ElementPhysicsModel> massThermalModel1;
    AMP::shared_ptr<AMP::Operator::ElementPhysicsModel> massThermalModel2;
    AMP::shared_ptr<AMP::Operator::ElementPhysicsModel> massOxygenModel;
    AMP::shared_ptr<AMP::Operator::LinearBVPOperator> massThermalOp1;
    AMP::shared_ptr<AMP::Operator::LinearBVPOperator> massThermalOp2;
    AMP::shared_ptr<AMP::Operator::LinearBVPOperator> massOxygenOp;
    AMP::shared_ptr<AMP::InputDatabase> massThermalOp_db1 =
        AMP::dynamic_pointer_cast<AMP::InputDatabase>(
            input_db->getDatabase( "MassThermalOperator1" ) );
    AMP::shared_ptr<AMP::InputDatabase> massThermalOp_db2 =
        AMP::dynamic_pointer_cast<AMP::InputDatabase>(
            input_db->getDatabase( "MassThermalOperator2" ) );
    AMP::shared_ptr<AMP::InputDatabase> massOxygenOp_db =
        AMP::dynamic_pointer_cast<AMP::InputDatabase>(
            input_db->getDatabase( "MassOxygenOperator" ) );
    massThermalOp1 = AMP::dynamic_pointer_cast<AMP::Operator::LinearBVPOperator>(
        AMP::Operator::OperatorBuilder::createOperator(
            meshAdapter1, massThermalOp_db1, massThermalModel1 ) );
    massThermalOp2 = AMP::dynamic_pointer_cast<AMP::Operator::LinearBVPOperator>(
        AMP::Operator::OperatorBuilder::createOperator(
            meshAdapter2, massThermalOp_db2, massThermalModel2 ) );
    massOxygenOp = AMP::dynamic_pointer_cast<AMP::Operator::LinearBVPOperator>(
        AMP::Operator::OperatorBuilder::createOperator(
            meshAdapter1, massOxygenOp_db, massOxygenModel ) );
    ...
    AMP::LinearAlgebra::Variable::shared_ptr TemperatureMapVar(
        new AMP::NodalScalarVariable( "TemperatureMap" ) );
    AMP::LinearAlgebra::Variable::shared_ptr inputMapVariable1(
        new AMP::NodalScalarVariable( "TemperatureMap", meshAdapter1 ) );
    AMP::LinearAlgebra::Variable::shared_ptr inputMapVariable2(
        new AMP::NodalScalarVariable( "TemperatureMap", meshAdapter2 ) );
    ...
    AMP::shared_ptr<AMP::Operator::ElementPhysicsModel> massICThermalModel1;
    AMP::shared_ptr<AMP::Operator::LinearBVPOperator> massICThermalOp;
    AMP::shared_ptr<AMP::InputDatabase> massICThermalOp_db1 =
        AMP::dynamic_pointer_cast<AMP::InputDatabase>(
            input_db->getDatabase( "MassICThermalOperator1" ) );
    massICThermalOp = AMP::dynamic_pointer_cast<AMP::Operator::LinearBVPOperator>(
        AMP::Operator::OperatorBuilder::createOperator(
            meshAdapter1, massICThermalOp_db1, massICThermalModel1 ) );
