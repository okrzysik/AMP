...
void thermalContactTest(AMP::UnitTest *ut, std::string exeName )
{
  ...
  boost::shared_ptr<AMP::Operator::VolumeIntegralOperator> sourceOperator = boost::dynamic_pointer_cast<AMP::Operator::VolumeIntegralOperator>(AMP::Operator::OperatorBuilder::createOperator(pelletMeshAdapter, sourceDatabase, stransportModel));
  ...
  boost::shared_ptr<AMP::Operator::ElementPhysicsModel> pelletThermalTransportModel;
  boost::shared_ptr<AMP::Database> pelletNonlinearThermalDatabase = input_db->getDatabase("pelletNonlinearThermalOperator");
  boost::shared_ptr<AMP::Operator::NonlinearBVPOperator> pelletNonlinearThermalOperator = boost::dynamic_pointer_cast<
  ...
  boost::shared_ptr<AMP::InputDatabase>  pelletLinearThermalDatabase= boost::dynamic_pointer_cast<AMP::InputDatabase>( input_db->getDatabase("pelletLinearThermalOperator"));
  boost::shared_ptr<AMP::Operator::LinearBVPOperator> pelletLinearThermalOperator = boost::dynamic_pointer_cast<AMP::Operator::LinearBVPOperator>(AMP::Operator::OperatorBuilder::createOperator(pelletMeshAdapter, pelletLinearThermalDatabase, pelletThermalTransportModel));

  // ---------------------------------------------------------------------------------------
  // create nonlinear pellet oxygen operator
  boost::shared_ptr<AMP::Operator::ElementPhysicsModel> pelletOxygenModel;
  boost::shared_ptr<AMP::Database> pelletNonlinearOxygenDatabase = input_db->getDatabase("pelletNonlinearOxygenOperator");
  boost::shared_ptr<AMP::Operator::NonlinearBVPOperator> pelletNonlinearOxygenOperator = boost::dynamic_pointer_cast<
  ...
  boost::shared_ptr<AMP::Operator::LinearBVPOperator> pelletLinearOxygenOperator;
  boost::shared_ptr<AMP::InputDatabase> linearOxygenOp_db =  boost::dynamic_pointer_cast<AMP::InputDatabase>(input_db->getDatabase("pelletLinearOxygenOperator"));
  pelletLinearOxygenOperator = boost::dynamic_pointer_cast<AMP::Operator::LinearBVPOperator>(AMP::Operator::OperatorBuilder::createOperator(pelletMeshAdapter, linearOxygenOp_db, pelletOxygenModel));
  
  //----------------------------------------------------------------------------------------------------------------------------------------------//
  // create nonlinear pellet mechanics operator
  AMP_INSIST( input_db->keyExists("pelletNonlinearMechanicsOperator"), "key missing!" );
  
  boost::shared_ptr<AMP::Operator::ElementPhysicsModel> pelletMechanicsMaterialModel;
  boost::shared_ptr<AMP::Database> pelletNonlinearMechanicsDatabase = input_db->getDatabase("pelletNonlinearMechanicsOperator");
  boost::shared_ptr<AMP::Operator::NonlinearBVPOperator> pelletNonlinearMechanicsOperator = boost::dynamic_pointer_cast<
  ...
  boost::shared_ptr<AMP::Operator::MechanicsNonlinearFEOperator> pelletMechanicsVolumeOperator = boost::dynamic_pointer_cast<
    AMP::Operator::MechanicsNonlinearFEOperator>(pelletNonlinearMechanicsOperator->getVolumeOperator());
 
  boost::shared_ptr<AMP::LinearAlgebra::Variable> pelletBurnupVar =pelletMechanicsVolumeOperator->getInputVariable(AMP::Operator::Mechanics::BURNUP);
  boost::shared_ptr<AMP::LinearAlgebra::Vector> pelletBurnupVector = pelletMeshAdapter->createVector(pelletBurnupVar);
  ...
  boost::shared_ptr<AMP::Database> pelletLinearMechanicsDatabase = input_db->getDatabase("pelletLinearMechanicsOperator");
  boost::shared_ptr<AMP::Operator::LinearBVPOperator> pelletLinearMechanicsOperator = boost::dynamic_pointer_cast<AMP::Operator::LinearBVPOperator>(
  ...
  boost::shared_ptr<AMP::Operator::ElementPhysicsModel> cladThermalTransportModel;
  boost::shared_ptr<AMP::Database> cladNonlinearThermalDatabase = input_db->getDatabase("cladNonlinearThermalOperator");
  boost::shared_ptr<AMP::Operator::NonlinearBVPOperator> cladNonlinearThermalOperator = boost::dynamic_pointer_cast<
  ...
  boost::shared_ptr<AMP::InputDatabase> cladLinearThermalDatabase = boost::dynamic_pointer_cast<AMP::InputDatabase>( input_db->getDatabase("cladLinearThermalOperator"));
  boost::shared_ptr<AMP::Operator::LinearBVPOperator> cladLinearThermalOperator = boost::dynamic_pointer_cast<
  ...
  boost::shared_ptr<AMP::Operator::ElementPhysicsModel> cladMechanicsMaterialModel;
  boost::shared_ptr<AMP::Database> cladNonlinearMechanicsDatabase = input_db->getDatabase("cladNonlinearMechanicsOperator");
  boost::shared_ptr<AMP::Operator::NonlinearBVPOperator> cladNonlinearMechanicsOperator = boost::dynamic_pointer_cast<
  ...
  boost::shared_ptr<AMP::Operator::MechanicsNonlinearFEOperator> cladMechanicsVolumeOperator = boost::dynamic_pointer_cast<
  ...
  boost::shared_ptr<AMP::Database> cladLinearMechanicsDatabase = input_db->getDatabase("cladLinearMechanicsOperator");
  boost::shared_ptr<AMP::Operator::LinearBVPOperator> cladLinearMechanicsOperator = boost::dynamic_pointer_cast<AMP::Operator::LinearBVPOperator>(
  ...
  boost::shared_ptr<AMP::Operator::MapSurface> mapcladtopellet = boost::dynamic_pointer_cast<AMP::Operator::MapSurface>(AMP::Operator::OperatorBuilder::createOperator(cladMeshAdapter, pelletMeshAdapter, mapcladtopellet_db ));
  ...
  boost::shared_ptr<AMP::Operator::MapSurface> mappellettoclad = boost::dynamic_pointer_cast<AMP::Operator::MapSurface>(AMP::Operator::OperatorBuilder::createOperator(pelletMeshAdapter, cladMeshAdapter, mappellettoclad_db ));
  ...
  boost::shared_ptr<AMP::InputDatabase> robinboundaryDatabase1 = boost::dynamic_pointer_cast<AMP::InputDatabase>( pelletNonlinearThermalDatabase->getDatabase("BoundaryOperator"));
...
//------------------------------------------
  ...
  boost::shared_ptr<AMP::InputDatabase> boundaryDatabase2      = boost::dynamic_pointer_cast<AMP::InputDatabase>( cladNonlinearThermalDatabase->getDatabase("BoundaryOperator"));
...
//-------------------------------------
  ...
  boost::shared_ptr<AMP::Operator::ElementPhysicsModel> pelletMassThermalModel;
  boost::shared_ptr<AMP::Operator::ElementPhysicsModel> cladMassThermalModel;
  boost::shared_ptr<AMP::Operator::ElementPhysicsModel> pelletMassOxygenModel;
  boost::shared_ptr<AMP::Operator::LinearBVPOperator> pelletMassThermalOperator;
  boost::shared_ptr<AMP::Operator::LinearBVPOperator> cladMassThermalOperator;
  boost::shared_ptr<AMP::Operator::LinearBVPOperator> pelletMassOxygenOperator;
  boost::shared_ptr<AMP::Operator::LinearBVPOperator> pelletMassMechanicsOperator;
  boost::shared_ptr<AMP::Operator::LinearBVPOperator> cladMassMechanicsOperator;
  
  boost::shared_ptr<AMP::InputDatabase> massThermalOp_db1 =  boost::dynamic_pointer_cast<AMP::InputDatabase>(input_db->getDatabase("pelletMassThermalOperator"));
  boost::shared_ptr<AMP::InputDatabase> massThermalOp_db2 =  boost::dynamic_pointer_cast<AMP::InputDatabase>(input_db->getDatabase("cladMassThermalOperator"));
  boost::shared_ptr<AMP::InputDatabase> pelletMassOxygenOperator_db =  boost::dynamic_pointer_cast<AMP::InputDatabase>(input_db->getDatabase("MassOxygenOperator"));
  pelletMassThermalOperator = boost::dynamic_pointer_cast<AMP::Operator::LinearBVPOperator>(AMP::Operator::OperatorBuilder::createOperator(pelletMeshAdapter, massThermalOp_db1,pelletMassThermalModel));
  cladMassThermalOperator = boost::dynamic_pointer_cast<AMP::Operator::LinearBVPOperator>(AMP::Operator::OperatorBuilder::createOperator(cladMeshAdapter, massThermalOp_db2,cladMassThermalModel));
  pelletMassOxygenOperator = boost::dynamic_pointer_cast<AMP::Operator::LinearBVPOperator>(AMP::Operator::OperatorBuilder::createOperator(pelletMeshAdapter, pelletMassOxygenOperator_db,pelletMassOxygenModel));
  ...
  boost::shared_ptr<AMP::Operator::ElementPhysicsModel> pelletMassICThermalModel;
  boost::shared_ptr<AMP::Operator::LinearBVPOperator> pelletMassICThermalOperator;
  boost::shared_ptr<AMP::InputDatabase> pelletMassICThermalOp_db =  boost::dynamic_pointer_cast<AMP::InputDatabase>(input_db->getDatabase("pelletMassICThermalOperator"));
  pelletMassICThermalOperator = boost::dynamic_pointer_cast<AMP::Operator::LinearBVPOperator>(AMP::Operator::OperatorBuilder::createOperator(pelletMeshAdapter, pelletMassICThermalOp_db,pelletMassICThermalModel));
  ...
  boost::shared_ptr<AMP::Database> pelletThermalPreconditioner_db = columnPreconditioner_db->getDatabase("pelletThermalPreconditioner"); 
  boost::shared_ptr<AMP::Solver::SolverStrategyParameters> pelletThermalPreconditionerParams(new AMP::Solver::SolverStrategyParameters(pelletThermalPreconditioner_db));
  pelletThermalPreconditionerParams->d_pOperator = columnLinearTimeOperator->getOperator(0);
  boost::shared_ptr<AMP::Solver::TrilinosMLSolver> pelletLinearThermalPreconditioner(new AMP::Solver::TrilinosMLSolver(pelletThermalPreconditionerParams));

  boost::shared_ptr<AMP::Database> cladThermalPreconditioner_db = columnPreconditioner_db->getDatabase("cladThermalPreconditioner"); 
  boost::shared_ptr<AMP::Solver::SolverStrategyParameters> cladThermalPreconditionerParams(new AMP::Solver::SolverStrategyParameters(cladThermalPreconditioner_db));
  cladThermalPreconditionerParams->d_pOperator = columnLinearTimeOperator->getOperator(1);
  boost::shared_ptr<AMP::Solver::TrilinosMLSolver> cladLinearThermalPreconditioner(new AMP::Solver::TrilinosMLSolver(cladThermalPreconditionerParams));

  boost::shared_ptr<AMP::Database> pelletOxygenPreconditioner_db = columnPreconditioner_db->getDatabase("pelletOxygenPreconditioner"); 
  boost::shared_ptr<AMP::Solver::SolverStrategyParameters> pelletOxygenPreconditionerParams(new AMP::Solver::SolverStrategyParameters(pelletOxygenPreconditioner_db));
  pelletOxygenPreconditionerParams->d_pOperator = columnLinearTimeOperator->getOperator(2);
  boost::shared_ptr<AMP::Solver::TrilinosMLSolver> pelletLinearOxygenPreconditioner(new AMP::Solver::TrilinosMLSolver(pelletOxygenPreconditionerParams));

  boost::shared_ptr<AMP::Database> pelletMechanicsPreconditioner_db = columnPreconditioner_db->getDatabase("pelletMechanicsPreconditioner"); 
  boost::shared_ptr<AMP::Solver::SolverStrategyParameters> pelletMechanicsPreconditionerParams(new AMP::Solver::SolverStrategyParameters(pelletMechanicsPreconditioner_db));
  pelletMechanicsPreconditionerParams->d_pOperator = columnLinearTimeOperator->getOperator(3);
  boost::shared_ptr<AMP::Solver::TrilinosMLSolver> pelletLinearMechanicsPreconditioner(new AMP::Solver::TrilinosMLSolver(pelletMechanicsPreconditionerParams));

  boost::shared_ptr<AMP::Database> cladMechanicsPreconditioner_db = columnPreconditioner_db->getDatabase("cladMechanicsPreconditioner"); 
  boost::shared_ptr<AMP::Solver::SolverStrategyParameters> cladMechanicsPreconditionerParams(new AMP::Solver::SolverStrategyParameters(cladMechanicsPreconditioner_db));
  cladMechanicsPreconditionerParams->d_pOperator = columnLinearTimeOperator->getOperator(4);
  boost::shared_ptr<AMP::Solver::TrilinosMLSolver> cladLinearMechanicsPreconditioner(new AMP::Solver::TrilinosMLSolver(cladMechanicsPreconditionerParams));
