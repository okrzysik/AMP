...
{
    std::string input_file = "input_testIDA-NonlinearOperator-short";
    std::string log_file = "output_testIDA-NonlinearOperator-short";
    ...
    boost::shared_ptr<AMP::Operator::Operator> genericOperator = AMP::Operator::OperatorBuilder::createOperator(meshAdapter,
														"NonlinearOperator",
														input_db,
														elementModel);
    ...
    linearOperator = boost::dynamic_pointer_cast<AMP::Operator::DiffusionLinearFEOperator>(AMP::Operator::OperatorBuilder::createOperator(meshAdapter,
																	  "LinearOperator",
																	  input_db,
																	  elementModel));
    ...
    massOperator = boost::dynamic_pointer_cast<AMP::Operator::MassLinearFEOperator>(AMP::Operator::OperatorBuilder::createOperator(meshAdapter,
																   "MassLinearOperator",
																   input_db,
																   massElementModel));
    ...
    boost::shared_ptr<AMP::Operator::VolumeIntegralOperator> sourceOperator1 = boost::dynamic_pointer_cast<AMP::Operator::VolumeIntegralOperator>(AMP::Operator::OperatorBuilder::createOperator(meshAdapter,
    ...
    boost::shared_ptr<AMP::Operator::VolumeIntegralOperator> sourceOperator2 = boost::dynamic_pointer_cast<AMP::Operator::VolumeIntegralOperator>(AMP::Operator::OperatorBuilder::createOperator(meshAdapter,
																								 "VolumeIntegralOperator2",
																								 input_db,
																								 manufacturedSourceModel2));
