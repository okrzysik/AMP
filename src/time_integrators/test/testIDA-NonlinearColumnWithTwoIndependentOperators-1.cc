...
void IDATimeIntegratorTest( AMP::UnitTest *ut )
{
    ...
    AMP::shared_ptr<AMP::Database> nonlinearDatabase1 =
    ...
    AMP::shared_ptr<AMP::InputDatabase> linearOp1_db =
        AMP::dynamic_pointer_cast<AMP::InputDatabase>(
            input_db->getDatabase( "LinearThermalOperator1" ) );
    AMP::shared_ptr<AMP::InputDatabase> linearOp2_db =
        AMP::dynamic_pointer_cast<AMP::InputDatabase>(
            input_db->getDatabase( "LinearThermalOperator2" ) );
    linearThermalOperator1 = AMP::dynamic_pointer_cast<AMP::Operator::LinearBVPOperator>(
        AMP::Operator::OperatorBuilder::createOperator(
            meshAdapter, linearOp1_db, elementModel1 ) );
    linearThermalOperator2 = AMP::dynamic_pointer_cast<AMP::Operator::LinearBVPOperator>(
        AMP::Operator::OperatorBuilder::createOperator(
            meshAdapter, linearOp2_db, elementModel2 ) );
    //----------------------------------------------------------------------------------------------------------------------------------------------//
    ...
    AMP::shared_ptr<AMP::InputDatabase> massOp1_db =
        AMP::dynamic_pointer_cast<AMP::InputDatabase>( input_db->getDatabase( "MassOperator1" ) );
    AMP::shared_ptr<AMP::InputDatabase> massOp2_db =
        AMP::dynamic_pointer_cast<AMP::InputDatabase>( input_db->getDatabase( "MassOperator2" ) );
    massOperator1 = AMP::dynamic_pointer_cast<AMP::Operator::LinearBVPOperator>(
        AMP::Operator::OperatorBuilder::createOperator(
            meshAdapter, massOp1_db, massElementModel1 ) );
    massOperator2 = AMP::dynamic_pointer_cast<AMP::Operator::LinearBVPOperator>(
        AMP::Operator::OperatorBuilder::createOperator(
            meshAdapter, massOp2_db, massElementModel2 ) );
    ...
    inputVar->add(
        thermalVolumeOperator1->getInputVariable( AMP::Operator::Diffusion::TEMPERATURE ) );
    inputVar->add(
        thermalVolumeOperator2->getInputVariable( AMP::Operator::Diffusion::TEMPERATURE ) );
    ...
    AMP::shared_ptr<AMP::Operator::VolumeIntegralOperator> sourceOperator =
        AMP::dynamic_pointer_cast<AMP::Operator::VolumeIntegralOperator>(
            AMP::Operator::OperatorBuilder::createOperator(
                meshAdapter, sourceDatabase, sourceTransportModel ) );

    // Create the power (heat source) vector.
    AMP::LinearAlgebra::Variable::shared_ptr powerInWattsVar =
        sourceOperator->createOutputVariable( "HeatSource" );
    ...
    AMP::Mesh::DOFMap::shared_ptr dof_map = meshAdapter->getDOFMap(
        thermalVolumeOperator1->getInputVariable( AMP::Operator::Diffusion::TEMPERATURE ) );

    AMP::shared_ptr<AMP::LinearAlgebra::Vector> thermalIC1 =
        initialCondition->subsetVectorForVariable(
            thermalVolumeOperator1->getInputVariable( AMP::Operator::Diffusion::TEMPERATURE ) );
    AMP::shared_ptr<AMP::LinearAlgebra::Vector> thermalIC2 =
        initialCondition->subsetVectorForVariable(
            thermalVolumeOperator2->getInputVariable( AMP::Operator::Diffusion::TEMPERATURE ) );
    int counter = 0;
    ...
    AMP::shared_ptr<AMP::LinearAlgebra::Vector> thermalRhs1 = f->subsetVectorForVariable(
        thermalVolumeOperator1->getInputVariable( AMP::Operator::Diffusion::TEMPERATURE ) );
    AMP::shared_ptr<AMP::LinearAlgebra::Vector> thermalRhs2 = f->subsetVectorForVariable(
        thermalVolumeOperator2->getInputVariable( AMP::Operator::Diffusion::TEMPERATURE ) );
    ...
    AMP::shared_ptr<AMP::Database> thermalPreconditioner1_db =
        columnPreconditioner_db->getDatabase( "thermalPreconditioner1" );
    AMP::shared_ptr<AMP::Database> thermalPreconditioner2_db =
        columnPreconditioner_db->getDatabase( "thermalPreconditioner2" );
    AMP::shared_ptr<AMP::Solver::SolverStrategyParameters> thermalPreconditionerParams1(
        new AMP::Solver::SolverStrategyParameters( thermalPreconditioner1_db ) );
    AMP::shared_ptr<AMP::Solver::SolverStrategyParameters> thermalPreconditionerParams2(
        new AMP::Solver::SolverStrategyParameters( thermalPreconditioner2_db ) );
