...
void thermalContactTest( AMP::UnitTest *ut, const std::string &exeName )
{
    ...
    AMP::LinearAlgebra::Vector::shared_ptr thermalPrime =
    ...
    AMP::LinearAlgebra::Vector::shared_ptr SpecificPowerVector =
        manager->createVector( SpecificPowerVar );
    ...
    // call apply, it serves two purposes, 1) called before the getJacobian for mechanics(not sure
    // if needed)
    //                                                       2)  form the rhs for the solve for the
    //                                                       time derivative of
    //                                                       temperature
    ...
    AMP::shared_ptr<AMP::Operator::DirichletVectorCorrection> dirichletBoundaryOperator =
    ...
    pelletLinearMechanicsOperator->reset(
        pelletNonlinearMechanicsOperator->getParameters( "Jacobian", mechanicsSolution ) );
    //-------------------------------------------------------------------------------------------
    ...
    timeOperator_db->putInteger( "algebraicComponent",
                                 ida_db->getIntegerWithDefault( "algebraicComponent", -1 ) );
