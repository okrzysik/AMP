                                ...
                                double *v1 )
{
    ...
    double x2[2];
    int N2_max = 0;
    for ( int i = 0; i < N; i++ ) N2_max = std::max( N2_max, N2[i] );
    ...
    for ( int i = 0; i < N; i++ ) {
        for ( int j = 0; j < N2[i]; j++ ) C1[i][j] = C0[i][j];
    }
